...
use google\devtools\clouderrorreporting\v1beta1\ErrorGroupServiceClient;
 ...
 * ```
 * try {
 *     $errorGroupServiceApi = new ErrorGroupServiceApi();
 *     $formattedGroupName = ErrorGroupServiceApi::formatGroupName("[PROJECT]", "[GROUP]");
 *     $response = $errorGroupServiceApi->getGroup($formattedGroupName);
 * } finally {
 *     if (isset($errorGroupServiceApi)) {
 *         $errorGroupServiceApi->close();
 *     }
 * }
 * ```
 *
...
class ErrorGroupServiceApi
{
    ...
    public function __construct($options = [])
    {
        ...
        $createErrorGroupServiceStubFunction = function ($hostname, $opts) {
            return new ErrorGroupServiceClient($hostname, $opts);
        };
     ...
     *     $response = $errorGroupServiceApi->updateGroup($group);
     * } finally {
     *     if (isset($errorGroupServiceApi)) {
     *         $errorGroupServiceApi->close();
     *     }
