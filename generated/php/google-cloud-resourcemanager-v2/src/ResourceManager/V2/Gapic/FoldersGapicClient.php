...
class FoldersGapicClient
{
     ...
     *     $query = '';
     *     // Iterate through all elements
     *     $pagedResponse = $foldersClient->searchFolders($query);
     *     foreach ($pagedResponse->iterateAllElements() as $element) {
     *         // doSomethingWith($element);
     *     }
     *
     ...
     * ```
     *
     * @param string $query Search criteria used to select the Folders to return.
     ...
     * @experimental
     */
    public function searchFolders($query, $optionalArgs = [])
    {
