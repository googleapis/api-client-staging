...
namespace Google\Cloud\Functions\Tests\Unit\V1beta2;

use Google\Cloud\Functions\V1beta2\CloudFunctionsServiceClient;
...
class CloudFunctionsServiceClientTest extends GeneratedTest
{
    ...
    public function listFunctionsTest()
    {
        ...
        $response = $client->listFunctions($formattedLocation);
        ...
        $this->assertSame('/google.cloud.functions.v1beta2.CloudFunctionsService/ListFunctions', $actualFuncCall);
    ...
    public function listFunctionsExceptionTest()
    {
        ...
        try {
            $client->listFunctions($formattedLocation);
    ...
    public function getFunctionTest()
    {
        ...
        $latestOperation = 'latestOperation-1633164625';
        ...
        $expectedResponse->setLatestOperation($latestOperation);
        ...
        // Mock request
        $formattedName = $client->functionName('[PROJECT]', '[LOCATION]', '[FUNCTION]');
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.functions.v1beta2.CloudFunctionsService/GetFunction', $actualFuncCall);
    ...
    public function createFunctionTest()
    {
        ...
        $this->assertSame('/google.cloud.functions.v1beta2.CloudFunctionsService/CreateFunction', $actualApiFuncCall);
    ...
    public function updateFunctionTest()
    {
        ...
        $response = $client->updateFunction($formattedName, $function);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.functions.v1beta2.CloudFunctionsService/UpdateFunction', $actualApiFuncCall);
    ...
    public function deleteFunctionTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.functions.v1beta2.CloudFunctionsService/DeleteFunction', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getName();
    ...
    public function callFunctionTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.functions.v1beta2.CloudFunctionsService/CallFunction', $actualFuncCall);
