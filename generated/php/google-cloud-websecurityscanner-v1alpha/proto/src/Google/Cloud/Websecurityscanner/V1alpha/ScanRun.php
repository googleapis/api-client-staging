...
class ScanRun extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Websecurityscanner\V1alpha\ScanRun_ExecutionState::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Websecurityscanner\V1alpha\ScanRun_ResultState::class);
