...
namespace Google\Cloud\Api\Servicemanagement\Tests\System\V1;
 ...
 * @group grpc
 */
class ServiceManagerSmokeTest extends GeneratedTest
{
    /**
     * @test
     */
    public function listServicesTest()
    {
        ...
        $consumerId = '';
        $serviceManagerClient->listServices(['producerProjectId' => $producerProjectId, 'consumerId' => $consumerId]);
    }
}
