...
class ContainerAnalysisGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Devtools\Containeranalysis\V1alpha1\CreateOperationRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     */
    public function CreateOperation(\Google\Devtools\Containeranalysis\V1alpha1\CreateOperationRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.devtools.containeranalysis.v1alpha1.ContainerAnalysis/CreateOperation',
        $argument,
     ...
     * change the result.
     * @param \Google\Devtools\Containeranalysis\V1alpha1\UpdateOperationRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     */
    public function UpdateOperation(\Google\Devtools\Containeranalysis\V1alpha1\UpdateOperationRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.devtools.containeranalysis.v1alpha1.ContainerAnalysis/UpdateOperation',
        $argument,
        ['\Google\LongRunning\Operation', 'decode'],
        $metadata, $options);
    }
     ...
     * @param \Google\Devtools\Containeranalysis\V1alpha1\GetScanConfigRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     */
    public function GetScanConfig(\Google\Devtools\Containeranalysis\V1alpha1\GetScanConfigRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.devtools.containeranalysis.v1alpha1.ContainerAnalysis/GetScanConfig',
        $argument,
        ['\Google\Devtools\Containeranalysis\V1alpha1\ScanConfig', 'decode'],
        $metadata, $options);
    }

    /**
     * Lists scan configurations for a project.
     * @param \Google\Devtools\Containeranalysis\V1alpha1\ListScanConfigsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     */
    public function ListScanConfigs(\Google\Devtools\Containeranalysis\V1alpha1\ListScanConfigsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.devtools.containeranalysis.v1alpha1.ContainerAnalysis/ListScanConfigs',
        $argument,
        ['\Google\Devtools\Containeranalysis\V1alpha1\ListScanConfigsResponse', 'decode'],
        $metadata, $options);
    }

    /**
     * Updates the scan configuration to a new value.
     * @param \Google\Devtools\Containeranalysis\V1alpha1\UpdateScanConfigRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     */
    public function UpdateScanConfig(\Google\Devtools\Containeranalysis\V1alpha1\UpdateScanConfigRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.devtools.containeranalysis.v1alpha1.ContainerAnalysis/UpdateScanConfig',
        $argument,
        ['\Google\Devtools\Containeranalysis\V1alpha1\ScanConfig', 'decode'],
        $metadata, $options);
    }
