...
namespace Google\Cloud\TextToSpeech\Tests\Unit\V1beta1;

use Google\Cloud\TextToSpeech\V1beta1\TextToSpeechClient;
...
class TextToSpeechClientTest extends GeneratedTest
{
    ...
    public function listVoicesTest()
    {
        ...
        $this->assertSame('/google.cloud.texttospeech.v1beta1.TextToSpeech/ListVoices', $actualFuncCall);
    ...
    public function synthesizeSpeechTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.texttospeech.v1beta1.TextToSpeech/SynthesizeSpeech', $actualFuncCall);
