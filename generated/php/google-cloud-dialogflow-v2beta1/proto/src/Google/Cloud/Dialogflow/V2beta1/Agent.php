...
class Agent extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.Agent.MatchMode match_mode = 9;</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Dialogflow\V2beta1\Agent_MatchMode::class);
        $this->match_mode = $var;
