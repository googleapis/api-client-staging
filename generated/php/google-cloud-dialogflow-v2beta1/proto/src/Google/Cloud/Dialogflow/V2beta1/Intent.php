...
class Intent extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>bool ml_enabled = 5;</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.v2beta1.Intent.TrainingPhrase training_phrases = 9;</code>
     * @param \Google\Cloud\Dialogflow\V2beta1\Intent_TrainingPhrase[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setTrainingPhrases($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Dialogflow\V2beta1\Intent_TrainingPhrase::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.v2beta1.Intent.Parameter parameters = 13;</code>
     * @param \Google\Cloud\Dialogflow\V2beta1\Intent_Parameter[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setParameters($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Dialogflow\V2beta1\Intent_Parameter::class);
        $this->parameters = $arr;
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::ENUM, \Google\Cloud\Dialogflow\V2beta1\Intent_Message_Platform::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.v2beta1.Intent.FollowupIntentInfo followup_intent_info = 18;</code>
     * @param \Google\Cloud\Dialogflow\V2beta1\Intent_FollowupIntentInfo[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setFollowupIntentInfo($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Dialogflow\V2beta1\Intent_FollowupIntentInfo::class);
