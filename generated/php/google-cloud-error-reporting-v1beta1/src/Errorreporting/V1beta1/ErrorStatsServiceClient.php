 ...
 *     foreach ($errorStatsServiceClient->listGroupStats($formattedProjectName, $timeRange) as $element) {
...
class ErrorStatsServiceClient
{
     ...
     *     $formattedProjectName = ErrorStatsServiceClient::formatProjectName("[PROJECT]");
     *     $groupId = "";
     *     foreach ($errorStatsServiceClient->listEvents($formattedProjectName, $groupId) as $element) {
     *         // doThingsWith(element);
     *     }
     * } finally {
     *     if (isset($errorStatsServiceClient)) {
