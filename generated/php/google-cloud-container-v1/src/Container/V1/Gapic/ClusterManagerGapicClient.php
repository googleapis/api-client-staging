...
use Google\Container\V1\AddonsConfig;
use Google\Container\V1\CancelOperationRequest;
use Google\Container\V1\Cluster;
use Google\Container\V1\ClusterManagerGrpcClient;
use Google\Container\V1\ClusterUpdate;
use Google\Container\V1\CompleteIPRotationRequest;
use Google\Container\V1\CreateClusterRequest;
use Google\Container\V1\CreateNodePoolRequest;
use Google\Container\V1\DeleteClusterRequest;
use Google\Container\V1\DeleteNodePoolRequest;
use Google\Container\V1\GetClusterRequest;
use Google\Container\V1\GetNodePoolRequest;
use Google\Container\V1\GetOperationRequest;
use Google\Container\V1\GetServerConfigRequest;
use Google\Container\V1\ListClustersRequest;
use Google\Container\V1\ListNodePoolsRequest;
use Google\Container\V1\ListOperationsRequest;
use Google\Container\V1\MaintenancePolicy;
use Google\Container\V1\MasterAuth;
use Google\Container\V1\NetworkPolicy;
use Google\Container\V1\NodeManagement;
use Google\Container\V1\NodePool;
use Google\Container\V1\NodePoolAutoscaling;
use Google\Container\V1\RollbackNodePoolUpgradeRequest;
use Google\Container\V1\SetAddonsConfigRequest;
use Google\Container\V1\SetLabelsRequest;
use Google\Container\V1\SetLegacyAbacRequest;
use Google\Container\V1\SetLocationsRequest;
use Google\Container\V1\SetLoggingServiceRequest;
use Google\Container\V1\SetMaintenancePolicyRequest;
use Google\Container\V1\SetMasterAuthRequest;
use Google\Container\V1\SetMasterAuthRequest_Action as Action;
use Google\Container\V1\SetMonitoringServiceRequest;
use Google\Container\V1\SetNetworkPolicyRequest;
use Google\Container\V1\SetNodePoolAutoscalingRequest;
use Google\Container\V1\SetNodePoolManagementRequest;
use Google\Container\V1\SetNodePoolSizeRequest;
use Google\Container\V1\StartIPRotationRequest;
use Google\Container\V1\UpdateClusterRequest;
use Google\Container\V1\UpdateMasterRequest;
use Google\Container\V1\UpdateNodePoolRequest;
...
class ClusterManagerGapicClient
{
     ...
     *                                 For allowed values, use constants defined on {@see \Google\Container\V1\SetMasterAuthRequest_Action}
