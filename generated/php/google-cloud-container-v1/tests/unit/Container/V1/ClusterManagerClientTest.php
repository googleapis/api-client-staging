...
use Google\Container\V1\ListClustersResponse;
use Google\Container\V1\ListNodePoolsResponse;
use Google\Container\V1\ListOperationsResponse;
...
use Google\Container\V1\Operation;
use Google\Container\V1\ServerConfig;
