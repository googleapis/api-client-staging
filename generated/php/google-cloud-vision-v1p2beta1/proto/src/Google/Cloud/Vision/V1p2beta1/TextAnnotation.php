 ...
 * detail.
 *
 * Generated from protobuf message <code>google.cloud.vision.v1p2beta1.TextAnnotation</code>
 */
class TextAnnotation extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.vision.v1p2beta1.Page pages = 1;</code>
     */
    private $pages;
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.vision.v1p2beta1.Page pages = 1;</code>
     * @param \Google\Cloud\Vision\V1p2beta1\Page[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setPages($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Vision\V1p2beta1\Page::class);
        $this->pages = $arr;
