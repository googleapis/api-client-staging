...
func (*DeleteLogRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0} }
...
func (*WriteLogEntriesRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{1} }
...
func (*WriteLogEntriesResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{2} }
...
func (*ListLogEntriesRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{3} }
...
func (*ListLogEntriesResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{4} }
...
func (*ListLogsRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{7} }
...
func (*ListLogsResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{8} }
...
func init() { proto.RegisterFile("google/logging/v2/logging.proto", fileDescriptor0) }
