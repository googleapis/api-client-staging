...
var (
	dlpResultPathTemplate = gax.MustCompilePathTemplate("inspect/results/{result}")
)
...
// DlpResultPath returns the path for the result resource.
func DlpResultPath(result string) string {
	path, err := dlpResultPathTemplate.Render(map[string]string{
		"result": result,
	})
	if err != nil {
		panic(err)
...
// InspectContent find potentially sensitive info in a list of strings.
...
// RedactContent redact potentially sensitive info from a list of strings.
// This method has limits on input size, processing time, and output size.
...
// CreateInspectOperation schedule a job scanning content in a Google Cloud Platform data repository.
func (c *Client) CreateInspectOperation(ctx context.Context, req *dlppb.CreateInspectOperationRequest, opts ...gax.CallOption) (*CreateInspectOperationOperation, error) {
	ctx = insertXGoog(ctx, c.xGoogHeader)
	...
	return &CreateInspectOperationOperation{
...
// CreateInspectOperationOperation manages a long-running operation from CreateInspectOperation.
type CreateInspectOperationOperation struct {
	lro *longrunning.Operation
}

// CreateInspectOperationOperation returns a new CreateInspectOperationOperation from a given name.
// The name must be that of a previously created CreateInspectOperationOperation, possibly from a different process.
func (c *Client) CreateInspectOperationOperation(name string) *CreateInspectOperationOperation {
	return &CreateInspectOperationOperation{
...
func (op *CreateInspectOperationOperation) Wait(ctx context.Context, opts ...gax.CallOption) (*dlppb.InspectOperationResult, error) {
...
func (op *CreateInspectOperationOperation) Poll(ctx context.Context, opts ...gax.CallOption) (*dlppb.InspectOperationResult, error) {
	var resp dlppb.InspectOperationResult
...
func (op *CreateInspectOperationOperation) Metadata() (*dlppb.InspectOperationMetadata, error) {
...
func (op *CreateInspectOperationOperation) Done() bool {
	return op.lro.Done()
}

// Name returns the name of the long-running operation.
// The name is assigned by the server and is unique within the service from which the operation is created.
func (op *CreateInspectOperationOperation) Name() string {
	return op.lro.Name()
}
