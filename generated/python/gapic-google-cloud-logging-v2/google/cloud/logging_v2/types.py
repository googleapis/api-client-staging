...
names = []
for module in (distribution_pb2, http_pb2, label_pb2, metric_pb2,
               monitored_resource_pb2, log_entry_pb2, logging_config_pb2,
               logging_metrics_pb2, logging_pb2, http_request_pb2, any_pb2,
               descriptor_pb2, duration_pb2, empty_pb2, struct_pb2,
               timestamp_pb2, status_pb2, ):
