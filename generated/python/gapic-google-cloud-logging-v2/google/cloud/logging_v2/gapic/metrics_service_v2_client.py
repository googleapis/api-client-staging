...
class MetricsServiceV2Client(object):
    ...
    def create_log_metric(self, parent, metric, options=None):
        ...
        Args:
          ...
          metric (Union[dict|:class:`google.cloud.proto.logging.v2.logging_metrics_pb2.LogMetric`]): The new logs-based metric, which must not have an identifier that
            already exists.
            If a dict is provided, it must be of the same form as the protobuf
            message :class:`google.cloud.proto.logging.v2.logging_metrics_pb2.LogMetric`
          options (:class:`google.gax.CallOptions`): Overrides the default
            settings for this call, e.g, timeout, retries etc.
    ...
    def update_log_metric(self, metric_name, metric, options=None):
        ...
        Args:
          ...
          metric (Union[dict|:class:`google.cloud.proto.logging.v2.logging_metrics_pb2.LogMetric`]): The updated metric.
            If a dict is provided, it must be of the same form as the protobuf
            message :class:`google.cloud.proto.logging.v2.logging_metrics_pb2.LogMetric`
          options (:class:`google.gax.CallOptions`): Overrides the default
            settings for this call, e.g, timeout, retries etc.
