...
class LoggingServiceV2Client(object):
    ...
    def write_log_entries(self,
        ...
        Args:
          entries (list[Union[dict|:class:`google.cloud.proto.logging.v2.log_entry_pb2.LogEntry`]]): Required.  The log entries to write. Values supplied for the fields
            ...
            message :class:`google.cloud.proto.logging.v2.log_entry_pb2.LogEntry`
          log_name (str): Optional. A default log resource name that is assigned to all log entries
            ...
            For more information about log names, see
            ``LogEntry``.
          resource (Union[dict|:class:`google.api.monitored_resource_pb2.MonitoredResource`]): Optional. A default monitored resource object that is assigned to all log
            ...
            See ``LogEntry``.
            If a dict is provided, it must be of the same form as the protobuf
            message :class:`google.api.monitored_resource_pb2.MonitoredResource`
