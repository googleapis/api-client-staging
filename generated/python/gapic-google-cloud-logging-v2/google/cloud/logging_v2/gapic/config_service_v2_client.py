...
class ConfigServiceV2Client(object):
    ...
    def create_sink(self,
        ...
        Args:
          ...
          sink (Union[dict|:class:`google.cloud.proto.logging.v2.logging_config_pb2.LogSink`]): Required. The new sink, whose ``name`` parameter is a sink identifier that
            is not already in use.
            If a dict is provided, it must be of the same form as the protobuf
            message :class:`google.cloud.proto.logging.v2.logging_config_pb2.LogSink`
    ...
    def update_sink(self,
        ...
        Args:
          sink_name (str): Required. The full resource name of the sink to update, including the
            ...
            Example: ``\"projects/my-project-id/sinks/my-sink-id\"``.
          sink (Union[dict|:class:`google.cloud.proto.logging.v2.logging_config_pb2.LogSink`]): Required. The updated sink, whose name is the same identifier that appears
