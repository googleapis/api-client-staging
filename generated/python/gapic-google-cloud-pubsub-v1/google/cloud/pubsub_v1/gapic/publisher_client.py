...
class PublisherClient(object):
    ...
    def update_topic(self, topic, update_mask, options=None):
        ...
        Args:
          topic (Union[dict|:class:`google.cloud.proto.pubsub.v1.pubsub_pb2.Topic`]): The topic to update.
            If a dict is provided, it must be of the same form as the protobuf
            message :class:`google.cloud.proto.pubsub.v1.pubsub_pb2.Topic`
          update_mask (Union[dict|:class:`google.protobuf.field_mask_pb2.FieldMask`]): Indicates which fields in the provided topic to update.
    ...
    def publish(self, topic, messages, options=None):
        ...
        Args:
          ...
          messages (list[Union[dict|:class:`google.cloud.proto.pubsub.v1.pubsub_pb2.PubsubMessage`]]): The messages to publish.
            If a dict is provided, it must be of the same form as the protobuf
            message :class:`google.cloud.proto.pubsub.v1.pubsub_pb2.PubsubMessage`
          options (:class:`google.gax.CallOptions`): Overrides the default
            settings for this call, e.g, timeout, retries etc.
