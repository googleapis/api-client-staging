...
class SubscriberClient(object):
    ...
    def match_project_from_snapshot_name(cls, snapshot_name):
        ...
        Args:
            snapshot_name (str): A fully-qualified path representing a snapshot
                resource.
    ...
    def match_project_from_subscription_name(cls, subscription_name):
        ...
        Args:
            subscription_name (str): A fully-qualified path representing a subscription
                resource.
    ...
    def __init__(self,
        ...
        defaults = api_callable.construct_settings(
            ...
            subscriber_client_config.config,
            client_config,
