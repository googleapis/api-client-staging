...
class SubscriberClient(object):
    ...
    def create_subscription(self,
        ...
        Args:
          ...
          topic (str): The name of the topic from which this subscription is receiving messages.
            ...
            deleted.
          push_config (Union[dict|:class:`google.cloud.proto.pubsub.v1.pubsub_pb2.PushConfig`]): If push delivery is used with this subscription, this field is
            used to configure it. An empty ``pushConfig`` signifies that the subscriber
            will pull and ack messages using API methods.
            If a dict is provided, it must be of the same form as the protobuf
            message :class:`google.cloud.proto.pubsub.v1.pubsub_pb2.PushConfig`
          ...
          retain_acked_messages (bool): Indicates whether to retain acknowledged messages. If true, then
            ...
            window.
          message_retention_duration (Union[dict|:class:`google.protobuf.duration_pb2.Duration`]): How long to retain unacknowledged messages in the subscription's backlog,
    ...
    def update_subscription(self, subscription, update_mask, options=None):
        ...
        Args:
          subscription (Union[dict|:class:`google.cloud.proto.pubsub.v1.pubsub_pb2.Subscription`]): The updated subscription object.
            If a dict is provided, it must be of the same form as the protobuf
            message :class:`google.cloud.proto.pubsub.v1.pubsub_pb2.Subscription`
          update_mask (Union[dict|:class:`google.protobuf.field_mask_pb2.FieldMask`]): Indicates which fields in the provided subscription to update.
    ...
    def streaming_pull(self, requests, options=None):
        ...
        Returns:
          Iterable[:class:`google.cloud.proto.pubsub.v1.pubsub_pb2.StreamingPullResponse`].
    ...
    def modify_push_config(self, subscription, push_config, options=None):
        ...
        Args:
          subscription (str): The name of the subscription.
            Format is ``projects/{project}/subscriptions/{sub}``.
          push_config (Union[dict|:class:`google.cloud.proto.pubsub.v1.pubsub_pb2.PushConfig`]): The push configuration for future deliveries.
    ...
    def update_snapshot(self, snapshot, update_mask, options=None):
        ...
        Args:
          snapshot (Union[dict|:class:`google.cloud.proto.pubsub.v1.pubsub_pb2.Snapshot`]): The updated snpashot object.
            If a dict is provided, it must be of the same form as the protobuf
            message :class:`google.cloud.proto.pubsub.v1.pubsub_pb2.Snapshot`
          update_mask (Union[dict|:class:`google.protobuf.field_mask_pb2.FieldMask`]): Indicates which fields in the provided snapshot to update.
            Must be specified and non-empty.
            If a dict is provided, it must be of the same form as the protobuf
            message :class:`google.protobuf.field_mask_pb2.FieldMask`
          options (:class:`google.gax.CallOptions`): Overrides the default
    ...
    def seek(self, subscription, time=None, snapshot=None, options=None):
        ...
        Args:
          ...
          time (Union[dict|:class:`google.protobuf.timestamp_pb2.Timestamp`]): The time to seek to.
    ...
    def set_iam_policy(self, resource, policy, options=None):
        ...
        Args:
          ...
          policy (Union[dict|:class:`google.iam.v1.policy_pb2.Policy`]): REQUIRED: The complete policy to be applied to the ``resource``. The size of
            the policy is limited to a few 10s of KB. An empty policy is a
            valid policy but certain Cloud Platform services (such as Projects)
            might reject them.
            If a dict is provided, it must be of the same form as the protobuf
            message :class:`google.iam.v1.policy_pb2.Policy`
          options (:class:`google.gax.CallOptions`): Overrides the default
            settings for this call, e.g, timeout, retries etc.
