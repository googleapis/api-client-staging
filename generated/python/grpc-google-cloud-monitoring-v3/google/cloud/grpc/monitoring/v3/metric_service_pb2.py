...
# source: google/cloud/grpc/monitoring/v3/metric_service.proto
...
_LISTTIMESERIESREQUEST.fields_by_name['interval'].message_type = google_dot_cloud_dot_grpc_dot_monitoring_dot_v3_dot_common__pb2._TIMEINTERVAL
_LISTTIMESERIESREQUEST.fields_by_name['aggregation'].message_type = google_dot_cloud_dot_grpc_dot_monitoring_dot_v3_dot_common__pb2._AGGREGATION
...
_LISTTIMESERIESRESPONSE.fields_by_name['time_series'].message_type = google_dot_cloud_dot_grpc_dot_monitoring_dot_v3_dot_metric__pb2._TIMESERIES
_CREATETIMESERIESREQUEST.fields_by_name['time_series'].message_type = google_dot_cloud_dot_grpc_dot_monitoring_dot_v3_dot_metric__pb2._TIMESERIES
_CREATETIMESERIESERROR.fields_by_name['time_series'].message_type = google_dot_cloud_dot_grpc_dot_monitoring_dot_v3_dot_metric__pb2._TIMESERIES
...
ListMonitoredResourceDescriptorsRequest = _reflection.GeneratedProtocolMessageType('ListMonitoredResourceDescriptorsRequest', (_message.Message,), dict(
  ...
  __module__ = 'google.cloud.grpc.monitoring.v3.metric_service_pb2'
