...
# source: google/cloud/grpc/monitoring/v3/group_service.proto
...
_LISTGROUPSRESPONSE.fields_by_name['group'].message_type = google_dot_cloud_dot_grpc_dot_monitoring_dot_v3_dot_group__pb2._GROUP
_CREATEGROUPREQUEST.fields_by_name['group'].message_type = google_dot_cloud_dot_grpc_dot_monitoring_dot_v3_dot_group__pb2._GROUP
_UPDATEGROUPREQUEST.fields_by_name['group'].message_type = google_dot_cloud_dot_grpc_dot_monitoring_dot_v3_dot_group__pb2._GROUP
_LISTGROUPMEMBERSREQUEST.fields_by_name['interval'].message_type = google_dot_cloud_dot_grpc_dot_monitoring_dot_v3_dot_common__pb2._TIMEINTERVAL
...
ListGroupsRequest = _reflection.GeneratedProtocolMessageType('ListGroupsRequest', (_message.Message,), dict(
  ...
  __module__ = 'google.cloud.grpc.monitoring.v3.group_service_pb2'
...
try:
  ...
  def beta_create_GroupService_server(servicer, pool=None, pool_size=None, default_timeout=None, maximum_timeout=None):
    ...
    response_serializers = {
      ('google.monitoring.v3.GroupService', 'CreateGroup'): google_dot_cloud_dot_grpc_dot_monitoring_dot_v3_dot_group__pb2.Group.SerializeToString,
      ('google.monitoring.v3.GroupService', 'DeleteGroup'): google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
      ('google.monitoring.v3.GroupService', 'GetGroup'): google_dot_cloud_dot_grpc_dot_monitoring_dot_v3_dot_group__pb2.Group.SerializeToString,
      ...
      ('google.monitoring.v3.GroupService', 'UpdateGroup'): google_dot_cloud_dot_grpc_dot_monitoring_dot_v3_dot_group__pb2.Group.SerializeToString,
    }
  ...
  def beta_create_GroupService_stub(channel, host=None, metadata_transformer=None, pool=None, pool_size=None):
    ...
    response_deserializers = {
      ('google.monitoring.v3.GroupService', 'CreateGroup'): google_dot_cloud_dot_grpc_dot_monitoring_dot_v3_dot_group__pb2.Group.FromString,
      ('google.monitoring.v3.GroupService', 'DeleteGroup'): google_dot_protobuf_dot_empty__pb2.Empty.FromString,
      ('google.monitoring.v3.GroupService', 'GetGroup'): google_dot_cloud_dot_grpc_dot_monitoring_dot_v3_dot_group__pb2.Group.FromString,
      ...
      ('google.monitoring.v3.GroupService', 'UpdateGroup'): google_dot_cloud_dot_grpc_dot_monitoring_dot_v3_dot_group__pb2.Group.FromString,
    }
    cardinalities = {
