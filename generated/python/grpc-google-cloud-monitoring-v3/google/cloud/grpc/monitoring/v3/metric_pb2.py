...
# source: google/cloud/grpc/monitoring/v3/metric.proto
...
_POINT.fields_by_name['interval'].message_type = google_dot_cloud_dot_grpc_dot_monitoring_dot_v3_dot_common__pb2._TIMEINTERVAL
_POINT.fields_by_name['value'].message_type = google_dot_cloud_dot_grpc_dot_monitoring_dot_v3_dot_common__pb2._TYPEDVALUE
...
Point = _reflection.GeneratedProtocolMessageType('Point', (_message.Message,), dict(
  DESCRIPTOR = _POINT,
  __module__ = 'google.cloud.grpc.monitoring.v3.metric_pb2'
