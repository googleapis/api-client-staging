...
# source: google/cloud/grpc/monitoring/v3/common.proto
...
TypedValue = _reflection.GeneratedProtocolMessageType('TypedValue', (_message.Message,), dict(
  ...
  __module__ = 'google.cloud.grpc.monitoring.v3.common_pb2'
