...
# source: google/cloud/grpc/monitoring/v3/group.proto
...
Group = _reflection.GeneratedProtocolMessageType('Group', (_message.Message,), dict(
  DESCRIPTOR = _GROUP,
  __module__ = 'google.cloud.grpc.monitoring.v3.group_pb2'
