...
class ImageAnnotatorClient(object):
    ...
    def batch_annotate_images(self, requests, options=None):
        ...
        Args:
          requests (list[Union[dict|:class:`google.cloud.proto.vision.v1.image_annotator_pb2.AnnotateImageRequest`]]): Individual image annotation requests for this batch.
            If a dict is provided, it must be of the same form as the protobuf
            message :class:`google.cloud.proto.vision.v1.image_annotator_pb2.AnnotateImageRequest`
