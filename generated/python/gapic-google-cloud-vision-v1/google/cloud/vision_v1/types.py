...
names = []
for module in (http_pb2, geometry_pb2, image_annotator_pb2,
               text_annotation_pb2, web_detection_pb2, any_pb2, descriptor_pb2,
               wrappers_pb2, status_pb2, color_pb2, latlng_pb2, ):
