...
class ErrorGroupServiceClient(object):
    ...
    def update_group(self, group, options=None):
        ...
        Args:
          group (Union[dict|:class:`google.cloud.proto.devtools.clouderrorreporting.v1beta1.common_pb2.ErrorGroup`]): [Required] The group which replaces the resource on the server.
            If a dict is provided, it must be of the same form as the protobuf
            message :class:`google.cloud.proto.devtools.clouderrorreporting.v1beta1.common_pb2.ErrorGroup`
          options (:class:`google.gax.CallOptions`): Overrides the default
            settings for this call, e.g, timeout, retries etc.
