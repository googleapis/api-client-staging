...
class ReportErrorsServiceClient(object):
    ...
    def report_error_event(self, project_name, event, options=None):
        ...
        Args:
          ...
          event (Union[dict|:class:`google.cloud.proto.devtools.clouderrorreporting.v1beta1.report_errors_service_pb2.ReportedErrorEvent`]): [Required] The error event to be reported.
            If a dict is provided, it must be of the same form as the protobuf
            message :class:`google.cloud.proto.devtools.clouderrorreporting.v1beta1.report_errors_service_pb2.ReportedErrorEvent`
