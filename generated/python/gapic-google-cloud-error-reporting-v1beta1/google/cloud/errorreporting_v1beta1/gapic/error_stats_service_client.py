...
class ErrorStatsServiceClient(object):
    ...
    def list_group_stats(self,
        ...
        Args:
          ...
          time_range (Union[dict|:class:`google.cloud.proto.devtools.clouderrorreporting.v1beta1.error_stats_service_pb2.QueryTimeRange`]): [Optional] List data for the given time range.
            ...
            message :class:`google.cloud.proto.devtools.clouderrorreporting.v1beta1.error_stats_service_pb2.QueryTimeRange`
          group_id (list[str]): [Optional] List all <code>ErrorGroupStats</code> with these IDs.
          service_filter (Union[dict|:class:`google.cloud.proto.devtools.clouderrorreporting.v1beta1.error_stats_service_pb2.ServiceContextFilter`]): [Optional] List only <code>ErrorGroupStats</code> which belong to a service
            context that matches the filter.
            Data for all service contexts is returned if this field is not specified.
            If a dict is provided, it must be of the same form as the protobuf
            message :class:`google.cloud.proto.devtools.clouderrorreporting.v1beta1.error_stats_service_pb2.ServiceContextFilter`
          timed_count_duration (Union[dict|:class:`google.protobuf.duration_pb2.Duration`]): [Optional] The preferred duration for a single returned ``TimedCount``.
            If not set, no timed counts are returned.
            If a dict is provided, it must be of the same form as the protobuf
            message :class:`google.protobuf.duration_pb2.Duration`
          alignment (~.enums.TimedCountAlignment): [Optional] The alignment of the timed counts to be returned.
            Default is ``ALIGNMENT_EQUAL_AT_END``.
          alignment_time (Union[dict|:class:`google.protobuf.timestamp_pb2.Timestamp`]): [Optional] Time where the timed counts shall be aligned if rounded
            alignment is chosen. Default is 00:00 UTC.
            If a dict is provided, it must be of the same form as the protobuf
            message :class:`google.protobuf.timestamp_pb2.Timestamp`
          order (~.enums.ErrorGroupOrder): [Optional] The sort order in which the results are returned.
    ...
    def list_events(self,
        ...
        Args:
          ...
          service_filter (Union[dict|:class:`google.cloud.proto.devtools.clouderrorreporting.v1beta1.error_stats_service_pb2.ServiceContextFilter`]): [Optional] List only ErrorGroups which belong to a service context that
            matches the filter.
            Data for all service contexts is returned if this field is not specified.
            If a dict is provided, it must be of the same form as the protobuf
            message :class:`google.cloud.proto.devtools.clouderrorreporting.v1beta1.error_stats_service_pb2.ServiceContextFilter`
          time_range (Union[dict|:class:`google.cloud.proto.devtools.clouderrorreporting.v1beta1.error_stats_service_pb2.QueryTimeRange`]): [Optional] List only data for the given time range.
            If not set a default time range is used. The field time_range_begin
            in the response will specify the beginning of this time range.
            If a dict is provided, it must be of the same form as the protobuf
            message :class:`google.cloud.proto.devtools.clouderrorreporting.v1beta1.error_stats_service_pb2.QueryTimeRange`
