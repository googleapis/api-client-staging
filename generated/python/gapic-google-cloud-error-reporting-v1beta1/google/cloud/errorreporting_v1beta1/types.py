...
names = []
for module in (http_pb2, label_pb2, monitored_resource_pb2, common_pb2,
               error_group_service_pb2, error_stats_service_pb2,
               report_errors_service_pb2, descriptor_pb2, duration_pb2,
               timestamp_pb2, ):
