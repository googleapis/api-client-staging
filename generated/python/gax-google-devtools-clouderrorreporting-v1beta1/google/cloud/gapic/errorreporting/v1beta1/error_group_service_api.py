...
class ErrorGroupServiceApi(object):
    ...
    def __init__(self,
        ...
        self.stub = config.create_stub(
            error_group_service_pb2.beta_create_ErrorGroupService_stub,
            service_path,
            port,
            ssl_creds=ssl_creds,
            channel=channel,
    ...
    def get_group(self, group_name, options=None):
        ...
        Example:
          >>> from google.cloud.gapic.errorreporting.v1beta1.error_group_service_api import ErrorGroupServiceApi
          >>> api = ErrorGroupServiceApi()
