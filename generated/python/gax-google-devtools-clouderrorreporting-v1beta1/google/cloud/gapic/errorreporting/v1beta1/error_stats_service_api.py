...
class ErrorStatsServiceApi(object):
    ...
    def __init__(self,
        ...
        self.stub = config.create_stub(
            error_stats_service_pb2.beta_create_ErrorStatsService_stub,
            service_path,
            port,
            ssl_creds=ssl_creds,
            channel=channel,
        ...
        self._list_group_stats = api_callable.create_api_call(
            self.stub.ListGroupStats, settings=defaults['list_group_stats'])
        self._list_events = api_callable.create_api_call(
            self.stub.ListEvents, settings=defaults['list_events'])
        self._delete_events = api_callable.create_api_call(
            self.stub.DeleteEvents, settings=defaults['delete_events'])
    ...
    def list_group_stats(self,
        ...
        Example:
          >>> from google.cloud.gapic.errorreporting.v1beta1.error_stats_service_api import ErrorStatsServiceApi
          >>> from google.devtools.clouderrorreporting.v1beta1 import error_stats_service_pb2
          >>> from google.gax import CallOptions, INITIAL_PAGE
          >>> api = ErrorStatsServiceApi()
        ...
        Args:
          ...
          alignment (:class:`google.devtools.clouderrorreporting.v1beta1.error_stats_service_pb2.TimedCountAlignment`): [Optional] The alignment of the timed counts to be returned.
          ...
          order (:class:`google.devtools.clouderrorreporting.v1beta1.error_stats_service_pb2.ErrorGroupOrder`): [Optional] The sort order in which the results are returned.
        ...
        if alignment is None:
            alignment = error_stats_service_pb2.TimedCountAlignment.ERROR_COUNT_ALIGNMENT_UNSPECIFIED
        if alignment_time is None:
            alignment_time = timestamp_pb2.Timestamp()
        if order is None:
            order = error_stats_service_pb2.ErrorGroupOrder.GROUP_ORDER_UNSPECIFIED
