...
gapic-google-cloud-language-v1beta2 will allow you to connect to the `Google Cloud Natural Language API`_ and access all its methods. In order to achieve this, you need to set up authentication as well as install the library locally.
