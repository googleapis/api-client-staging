...
gapic-google-cloud-video-intelligence-v1beta1 will allow you to connect to the `Google Cloud Video Intelligence API`_ and access all its methods. In order to achieve this, you need to set up authentication as well as install the library locally.
