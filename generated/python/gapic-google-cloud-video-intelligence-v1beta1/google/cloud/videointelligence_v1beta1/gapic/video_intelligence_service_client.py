...
class VideoIntelligenceServiceClient(object):
    ...
    def __init__(self,
        ...
        metrics_headers['gapic'] = pkg_resources.get_distribution(
            'gapic-google-cloud-video-intelligence-v1beta1', ).version
    ...
    def annotate_video(self,
        ...
        Args:
          ...
          video_context (Union[dict|:class:`google.cloud.proto.videointelligence.v1beta1.video_intelligence_pb2.VideoContext`]): Additional video context and/or feature-specific parameters.
            If a dict is provided, it must be of the same form as the protobuf
            message :class:`google.cloud.proto.videointelligence.v1beta1.video_intelligence_pb2.VideoContext`
