...
class DataSourceType(object):
    ...
    Attributes:
      UNSPECIFIED_DATA_SOURCE_TYPE (int): An unspecified data source type.
        This corresponds to [google.api.MetricDescriptor.MetricKind.METRIC_KIND_UNSPECIFIED].
      GAUGE (int): An instantaneous measurement of a varying quantity.
        This corresponds to [google.api.MetricDescriptor.MetricKind.GAUGE].
      COUNTER (int): A cumulative value over time.
        This corresponds to [google.api.MetricDescriptor.MetricKind.CUMULATIVE].
      DERIVE (int): A rate of change of the measurement.
      ABSOLUTE (int): An amount of change since the last measurement interval.
