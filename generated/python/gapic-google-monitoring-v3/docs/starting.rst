...
gax-google-monitoring-v3 will allow you to connect to the `Google Monitoring API`_ and access all its methods. In order to achieve this, you need to set up authentication as well as install the library locally.
