"""A setup module for the GRPC google-devtools-clouderrorreporting service.
...
setuptools.setup(
  ...
  description='GRPC library for the google-devtools-clouderrorreporting-v1beta1 service',
