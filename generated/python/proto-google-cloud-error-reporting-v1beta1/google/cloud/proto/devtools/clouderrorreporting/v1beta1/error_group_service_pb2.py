...
# source: google/cloud/proto/devtools/clouderrorreporting/v1beta1/error_group_service.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/proto/devtools/clouderrorreporting/v1beta1/error_group_service.proto',
...
try:
  ...
  class ErrorGroupServiceStub(object):
    ...
    def __init__(self, channel):
      ...
      self.GetGroup = channel.unary_unary(
          ...
          response_deserializer=google_dot_cloud_dot_proto_dot_devtools_dot_clouderrorreporting_dot_v1beta1_dot_common__pb2.ErrorGroup.FromString,
          )
  ...
  def add_ErrorGroupServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
        'GetGroup': grpc.unary_unary_rpc_method_handler(
            ...
            response_serializer=google_dot_cloud_dot_proto_dot_devtools_dot_clouderrorreporting_dot_v1beta1_dot_common__pb2.ErrorGroup.SerializeToString,
        ),
  ...
  def beta_create_ErrorGroupService_server(servicer, pool=None, pool_size=None, default_timeout=None, maximum_timeout=None):
    ...
    response_serializers = {
      ('google.devtools.clouderrorreporting.v1beta1.ErrorGroupService', 'GetGroup'): google_dot_cloud_dot_proto_dot_devtools_dot_clouderrorreporting_dot_v1beta1_dot_common__pb2.ErrorGroup.SerializeToString,
      ('google.devtools.clouderrorreporting.v1beta1.ErrorGroupService', 'UpdateGroup'): google_dot_cloud_dot_proto_dot_devtools_dot_clouderrorreporting_dot_v1beta1_dot_common__pb2.ErrorGroup.SerializeToString,
    }
  ...
  def beta_create_ErrorGroupService_stub(channel, host=None, metadata_transformer=None, pool=None, pool_size=None):
    ...
    response_deserializers = {
      ('google.devtools.clouderrorreporting.v1beta1.ErrorGroupService', 'GetGroup'): google_dot_cloud_dot_proto_dot_devtools_dot_clouderrorreporting_dot_v1beta1_dot_common__pb2.ErrorGroup.FromString,
      ('google.devtools.clouderrorreporting.v1beta1.ErrorGroupService', 'UpdateGroup'): google_dot_cloud_dot_proto_dot_devtools_dot_clouderrorreporting_dot_v1beta1_dot_common__pb2.ErrorGroup.FromString,
    }
    cardinalities = {
