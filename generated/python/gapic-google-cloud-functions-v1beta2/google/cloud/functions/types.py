...
from google.cloud.proto.functions.v1beta2 import operations_pb2 as v1beta2_operations_pb2
...
names = []
for module in (auth_pb2, http_pb2, functions_pb2, v1beta2_operations_pb2,
