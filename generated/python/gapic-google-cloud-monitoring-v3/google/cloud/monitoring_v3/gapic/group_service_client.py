...
class GroupServiceClient(object):
    ...
    def create_group(self, name, group, validate_only=None, options=None):
        ...
        Args:
          name (str): The project in which to create the group. The format is
            ``\"projects/{project_id_or_number}\"``.
          group (Union[dict|:class:`google.cloud.proto.monitoring.v3.group_pb2.Group`]): A group definition. It is an error to define the ``name`` field because
            the system assigns the name.
            If a dict is provided, it must be of the same form as the protobuf
            message :class:`google.cloud.proto.monitoring.v3.group_pb2.Group`
    ...
    def update_group(self, group, validate_only=None, options=None):
        ...
        Args:
          group (Union[dict|:class:`google.cloud.proto.monitoring.v3.group_pb2.Group`]): The new definition of the group.  All fields of the existing group,
    ...
    def list_group_members(self,
        ...
        Args:
          ...
          interval (Union[dict|:class:`google.cloud.proto.monitoring.v3.common_pb2.TimeInterval`]): An optional time interval for which results should be returned. Only
