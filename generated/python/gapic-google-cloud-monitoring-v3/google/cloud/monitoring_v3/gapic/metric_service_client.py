...
class MetricServiceClient(object):
    ...
    def create_metric_descriptor(self, name, metric_descriptor, options=None):
        ...
        Args:
          name (str): The project on which to execute the request. The format is
            ``\"projects/{project_id_or_number}\"``.
          metric_descriptor (Union[dict|:class:`google.api.metric_pb2.MetricDescriptor`]): The new `custom metric <https://cloud.google.com/monitoring/custom-metrics>`_
            descriptor.
            If a dict is provided, it must be of the same form as the protobuf
            message :class:`google.api.metric_pb2.MetricDescriptor`
          options (:class:`google.gax.CallOptions`): Overrides the default
            settings for this call, e.g, timeout, retries etc.
    ...
    def list_time_series(self,
        ...
        Args:
          ...
          interval (Union[dict|:class:`google.cloud.proto.monitoring.v3.common_pb2.TimeInterval`]): The time interval for which results should be returned. Only time series
            that contain data points in the specified interval are included
            in the response.
            If a dict is provided, it must be of the same form as the protobuf
            message :class:`google.cloud.proto.monitoring.v3.common_pb2.TimeInterval`
          view (~.enums.ListTimeSeriesRequest.TimeSeriesView): Specifies which information is returned about the time series.
          aggregation (Union[dict|:class:`google.cloud.proto.monitoring.v3.common_pb2.Aggregation`]): By default, the raw time series data is returned.
            Use this field to combine multiple time series for different
            views of the data.
            If a dict is provided, it must be of the same form as the protobuf
            message :class:`google.cloud.proto.monitoring.v3.common_pb2.Aggregation`
    ...
    def create_time_series(self, name, time_series, options=None):
        ...
        Args:
          name (str): The project on which to execute the request. The format is
            ``\"projects/{project_id_or_number}\"``.
          time_series (list[Union[dict|:class:`google.cloud.proto.monitoring.v3.metric_pb2.TimeSeries`]]): The new data to be added to a list of time series.
            Adds at most one data point to each of several time series.  The new data
            point must be more recent than any other point in its time series.  Each
            ``TimeSeries`` value must fully specify a unique time series by supplying
            all label values for the metric and the monitored resource.
            If a dict is provided, it must be of the same form as the protobuf
            message :class:`google.cloud.proto.monitoring.v3.metric_pb2.TimeSeries`
          options (:class:`google.gax.CallOptions`): Overrides the default
            settings for this call, e.g, timeout, retries etc.
