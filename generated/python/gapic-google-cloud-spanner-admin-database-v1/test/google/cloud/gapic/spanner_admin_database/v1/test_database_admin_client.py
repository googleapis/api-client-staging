...
class TestDatabaseAdminClient(unittest.TestCase):
    ...
    def test_list_databases(self, mock_create_stub):
        ...
        # Mock response
        next_page_token = ''
        databases_element = spanner_database_admin_pb2.Database()
        databases = [databases_element]
        expected_response = spanner_database_admin_pb2.ListDatabasesResponse(
            next_page_token=next_page_token, databases=databases)
    ...
    def test_create_database(self, mock_create_stub):
        ...
        # Mock response
        name = 'name3373707'
        expected_response = spanner_database_admin_pb2.Database(name=name)
    ...
    def test_get_database(self, mock_create_stub):
        ...
        expected_response = spanner_database_admin_pb2.Database(name=name_2)
