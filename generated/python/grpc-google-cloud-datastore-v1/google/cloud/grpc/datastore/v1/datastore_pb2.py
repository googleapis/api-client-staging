...
# source: google/cloud/grpc/datastore/v1/datastore.proto
...
_LOOKUPREQUEST.fields_by_name['keys'].message_type = google_dot_cloud_dot_grpc_dot_datastore_dot_v1_dot_entity__pb2._KEY
_LOOKUPRESPONSE.fields_by_name['found'].message_type = google_dot_cloud_dot_grpc_dot_datastore_dot_v1_dot_query__pb2._ENTITYRESULT
_LOOKUPRESPONSE.fields_by_name['missing'].message_type = google_dot_cloud_dot_grpc_dot_datastore_dot_v1_dot_query__pb2._ENTITYRESULT
_LOOKUPRESPONSE.fields_by_name['deferred'].message_type = google_dot_cloud_dot_grpc_dot_datastore_dot_v1_dot_entity__pb2._KEY
_RUNQUERYREQUEST.fields_by_name['partition_id'].message_type = google_dot_cloud_dot_grpc_dot_datastore_dot_v1_dot_entity__pb2._PARTITIONID
_RUNQUERYREQUEST.fields_by_name['read_options'].message_type = _READOPTIONS
_RUNQUERYREQUEST.fields_by_name['query'].message_type = google_dot_cloud_dot_grpc_dot_datastore_dot_v1_dot_query__pb2._QUERY
_RUNQUERYREQUEST.fields_by_name['gql_query'].message_type = google_dot_cloud_dot_grpc_dot_datastore_dot_v1_dot_query__pb2._GQLQUERY
...
_RUNQUERYRESPONSE.fields_by_name['batch'].message_type = google_dot_cloud_dot_grpc_dot_datastore_dot_v1_dot_query__pb2._QUERYRESULTBATCH
_RUNQUERYRESPONSE.fields_by_name['query'].message_type = google_dot_cloud_dot_grpc_dot_datastore_dot_v1_dot_query__pb2._QUERY
...
_ALLOCATEIDSREQUEST.fields_by_name['keys'].message_type = google_dot_cloud_dot_grpc_dot_datastore_dot_v1_dot_entity__pb2._KEY
_ALLOCATEIDSRESPONSE.fields_by_name['keys'].message_type = google_dot_cloud_dot_grpc_dot_datastore_dot_v1_dot_entity__pb2._KEY
_MUTATION.fields_by_name['insert'].message_type = google_dot_cloud_dot_grpc_dot_datastore_dot_v1_dot_entity__pb2._ENTITY
_MUTATION.fields_by_name['update'].message_type = google_dot_cloud_dot_grpc_dot_datastore_dot_v1_dot_entity__pb2._ENTITY
_MUTATION.fields_by_name['upsert'].message_type = google_dot_cloud_dot_grpc_dot_datastore_dot_v1_dot_entity__pb2._ENTITY
_MUTATION.fields_by_name['delete'].message_type = google_dot_cloud_dot_grpc_dot_datastore_dot_v1_dot_entity__pb2._KEY
...
_MUTATIONRESULT.fields_by_name['key'].message_type = google_dot_cloud_dot_grpc_dot_datastore_dot_v1_dot_entity__pb2._KEY
...
LookupRequest = _reflection.GeneratedProtocolMessageType('LookupRequest', (_message.Message,), dict(
  ...
  __module__ = 'google.cloud.grpc.datastore.v1.datastore_pb2'
