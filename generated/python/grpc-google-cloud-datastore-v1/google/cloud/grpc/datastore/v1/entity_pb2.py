...
# source: google/cloud/grpc/datastore/v1/entity.proto
...
PartitionId = _reflection.GeneratedProtocolMessageType('PartitionId', (_message.Message,), dict(
  ...
  __module__ = 'google.cloud.grpc.datastore.v1.entity_pb2'
