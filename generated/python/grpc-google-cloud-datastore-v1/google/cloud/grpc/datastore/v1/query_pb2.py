...
# source: google/cloud/grpc/datastore/v1/query.proto
...
_ENTITYRESULT.fields_by_name['entity'].message_type = google_dot_cloud_dot_grpc_dot_datastore_dot_v1_dot_entity__pb2._ENTITY
...
_PROPERTYFILTER.fields_by_name['value'].message_type = google_dot_cloud_dot_grpc_dot_datastore_dot_v1_dot_entity__pb2._VALUE
...
_GQLQUERYPARAMETER.fields_by_name['value'].message_type = google_dot_cloud_dot_grpc_dot_datastore_dot_v1_dot_entity__pb2._VALUE
...
EntityResult = _reflection.GeneratedProtocolMessageType('EntityResult', (_message.Message,), dict(
  ...
  __module__ = 'google.cloud.grpc.datastore.v1.query_pb2'
