...
# source: google/cloud/grpc/devtools/clouderrorreporting/v1beta1/error_group_service.proto
...
_UPDATEGROUPREQUEST.fields_by_name['group'].message_type = google_dot_cloud_dot_grpc_dot_devtools_dot_clouderrorreporting_dot_v1beta1_dot_common__pb2._ERRORGROUP
...
GetGroupRequest = _reflection.GeneratedProtocolMessageType('GetGroupRequest', (_message.Message,), dict(
  ...
  __module__ = 'google.cloud.grpc.devtools.clouderrorreporting.v1beta1.error_group_service_pb2'
...
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('\n/com.google.devtools.clouderrorreporting.v1beta1B\026ErrorGroupServiceProtoP\001Z^google.golang.org/genproto/googleapis/devtools/clouderrorreporting/v1beta1;clouderrorreporting\252\002#Google.Cloud.ErrorReporting.V1Beta1'))
try:
  ...
  def beta_create_ErrorGroupService_server(servicer, pool=None, pool_size=None, default_timeout=None, maximum_timeout=None):
    ...
    response_serializers = {
      ('google.devtools.clouderrorreporting.v1beta1.ErrorGroupService', 'GetGroup'): google_dot_cloud_dot_grpc_dot_devtools_dot_clouderrorreporting_dot_v1beta1_dot_common__pb2.ErrorGroup.SerializeToString,
      ('google.devtools.clouderrorreporting.v1beta1.ErrorGroupService', 'UpdateGroup'): google_dot_cloud_dot_grpc_dot_devtools_dot_clouderrorreporting_dot_v1beta1_dot_common__pb2.ErrorGroup.SerializeToString,
    }
  ...
  def beta_create_ErrorGroupService_stub(channel, host=None, metadata_transformer=None, pool=None, pool_size=None):
    ...
    response_deserializers = {
      ('google.devtools.clouderrorreporting.v1beta1.ErrorGroupService', 'GetGroup'): google_dot_cloud_dot_grpc_dot_devtools_dot_clouderrorreporting_dot_v1beta1_dot_common__pb2.ErrorGroup.FromString,
      ('google.devtools.clouderrorreporting.v1beta1.ErrorGroupService', 'UpdateGroup'): google_dot_cloud_dot_grpc_dot_devtools_dot_clouderrorreporting_dot_v1beta1_dot_common__pb2.ErrorGroup.FromString,
    }
    cardinalities = {
