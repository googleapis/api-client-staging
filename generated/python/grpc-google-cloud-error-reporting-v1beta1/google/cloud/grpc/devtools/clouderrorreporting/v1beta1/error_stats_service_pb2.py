...
# source: google/cloud/grpc/devtools/clouderrorreporting/v1beta1/error_stats_service.proto
...
_ERRORGROUPSTATS.fields_by_name['group'].message_type = google_dot_cloud_dot_grpc_dot_devtools_dot_clouderrorreporting_dot_v1beta1_dot_common__pb2._ERRORGROUP
...
_ERRORGROUPSTATS.fields_by_name['affected_services'].message_type = google_dot_cloud_dot_grpc_dot_devtools_dot_clouderrorreporting_dot_v1beta1_dot_common__pb2._SERVICECONTEXT
_ERRORGROUPSTATS.fields_by_name['representative'].message_type = google_dot_cloud_dot_grpc_dot_devtools_dot_clouderrorreporting_dot_v1beta1_dot_common__pb2._ERROREVENT
...
_LISTEVENTSRESPONSE.fields_by_name['error_events'].message_type = google_dot_cloud_dot_grpc_dot_devtools_dot_clouderrorreporting_dot_v1beta1_dot_common__pb2._ERROREVENT
...
ListGroupStatsRequest = _reflection.GeneratedProtocolMessageType('ListGroupStatsRequest', (_message.Message,), dict(
  ...
  __module__ = 'google.cloud.grpc.devtools.clouderrorreporting.v1beta1.error_stats_service_pb2'
