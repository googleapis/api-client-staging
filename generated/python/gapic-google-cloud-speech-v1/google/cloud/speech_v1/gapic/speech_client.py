...
class SpeechClient(object):
    ...
    def recognize(self, config, audio, options=None):
        ...
        Args:
          config (Union[dict|:class:`google.cloud.proto.speech.v1.cloud_speech_pb2.RecognitionConfig`]): *Required* Provides information to the recognizer that specifies how to
            process the request.
            If a dict is provided, it must be of the same form as the protobuf
            message :class:`google.cloud.proto.speech.v1.cloud_speech_pb2.RecognitionConfig`
          audio (Union[dict|:class:`google.cloud.proto.speech.v1.cloud_speech_pb2.RecognitionAudio`]): *Required* The audio data to be recognized.
            If a dict is provided, it must be of the same form as the protobuf
            message :class:`google.cloud.proto.speech.v1.cloud_speech_pb2.RecognitionAudio`
    ...
    def streaming_recognize(self, requests, options=None):
        ...
        Returns:
          Iterable[:class:`google.cloud.proto.speech.v1.cloud_speech_pb2.StreamingRecognizeResponse`].
