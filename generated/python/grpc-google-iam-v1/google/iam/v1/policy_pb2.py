...
AuditConfigDelta = _reflection.GeneratedProtocolMessageType('AuditConfigDelta', (_message.Message,), dict(
  DESCRIPTOR = _AUDITCONFIGDELTA,
  __module__ = 'google.iam.v1.policy_pb2'
  ,
  __doc__ = """One delta entry for AuditConfig. Each individual change (only one
  exempted\_member in each entry) to a AuditConfig will be a separate
  entry.
  ...
  Attributes:
      ...
      log_type:
          Specifies the log\_type that was be enabled. ADMIN\_ACTIVITY
          is always enabled, and cannot be configured. Required
  """,
