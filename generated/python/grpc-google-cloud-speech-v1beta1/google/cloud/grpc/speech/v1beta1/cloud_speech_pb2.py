...
# source: google/cloud/grpc/speech/v1beta1/cloud_speech.proto
...
SyncRecognizeRequest = _reflection.GeneratedProtocolMessageType('SyncRecognizeRequest', (_message.Message,), dict(
  ...
  __module__ = 'google.cloud.grpc.speech.v1beta1.cloud_speech_pb2'
