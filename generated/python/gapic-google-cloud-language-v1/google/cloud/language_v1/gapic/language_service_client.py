...
class LanguageServiceClient(object):
    ...
    def analyze_sentiment(self, document, encoding_type=None, options=None):
        ...
        Args:
          document (Union[dict|:class:`google.cloud.proto.language.v1.language_service_pb2.Document`]): Input document.
            If a dict is provided, it must be of the same form as the protobuf
            message :class:`google.cloud.proto.language.v1.language_service_pb2.Document`
          encoding_type (~.enums.EncodingType): The encoding type used by the API to calculate sentence offsets.
    ...
    def annotate_text(self,
        ...
        Args:
          document (Union[dict|:class:`google.cloud.proto.language.v1.language_service_pb2.Document`]): Input document.
            If a dict is provided, it must be of the same form as the protobuf
            message :class:`google.cloud.proto.language.v1.language_service_pb2.Document`
          features (Union[dict|:class:`google.cloud.proto.language.v1.language_service_pb2.AnnotateTextRequest.Features`]): The enabled features.
            If a dict is provided, it must be of the same form as the protobuf
            message :class:`google.cloud.proto.language.v1.language_service_pb2.AnnotateTextRequest.Features`
          encoding_type (~.enums.EncodingType): The encoding type used by the API to calculate offsets.
          options (:class:`google.gax.CallOptions`): Overrides the default
            settings for this call, e.g, timeout, retries etc.
