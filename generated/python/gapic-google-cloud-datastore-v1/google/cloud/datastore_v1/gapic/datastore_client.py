...
class DatastoreClient(object):
    ...
    def lookup(self, project_id, keys, read_options=None, options=None):
        ...
        Args:
          ...
          keys (list[Union[dict|:class:`google.cloud.proto.datastore.v1.entity_pb2.Key`]]): Keys of entities to look up.
            If a dict is provided, it must be of the same form as the protobuf
            message :class:`google.cloud.proto.datastore.v1.entity_pb2.Key`
          read_options (Union[dict|:class:`google.cloud.proto.datastore.v1.datastore_pb2.ReadOptions`]): The options for this lookup request.
            If a dict is provided, it must be of the same form as the protobuf
            message :class:`google.cloud.proto.datastore.v1.datastore_pb2.ReadOptions`
    ...
    def run_query(self,
        ...
        Args:
          project_id (str): The ID of the project against which to make the request.
          partition_id (Union[dict|:class:`google.cloud.proto.datastore.v1.entity_pb2.PartitionId`]): Entities are partitioned into subsets, identified by a partition ID.
            Queries are scoped to a single partition.
            This partition ID is normalized with the standard default context
            partition ID.
            If a dict is provided, it must be of the same form as the protobuf
            message :class:`google.cloud.proto.datastore.v1.entity_pb2.PartitionId`
          read_options (Union[dict|:class:`google.cloud.proto.datastore.v1.datastore_pb2.ReadOptions`]): The options for this query.
            If a dict is provided, it must be of the same form as the protobuf
            message :class:`google.cloud.proto.datastore.v1.datastore_pb2.ReadOptions`
          query (Union[dict|:class:`google.cloud.proto.datastore.v1.query_pb2.Query`]): The query to run.
            If a dict is provided, it must be of the same form as the protobuf
            message :class:`google.cloud.proto.datastore.v1.query_pb2.Query`
          gql_query (Union[dict|:class:`google.cloud.proto.datastore.v1.query_pb2.GqlQuery`]): The GQL query to run.
            If a dict is provided, it must be of the same form as the protobuf
            message :class:`google.cloud.proto.datastore.v1.query_pb2.GqlQuery`
          options (:class:`google.gax.CallOptions`): Overrides the default
            settings for this call, e.g, timeout, retries etc.
    ...
    def begin_transaction(self,
        ...
        Args:
          project_id (str): The ID of the project against which to make the request.
          transaction_options (Union[dict|:class:`google.cloud.proto.datastore.v1.datastore_pb2.TransactionOptions`]): Options for a new transaction.
            If a dict is provided, it must be of the same form as the protobuf
            message :class:`google.cloud.proto.datastore.v1.datastore_pb2.TransactionOptions`
          options (:class:`google.gax.CallOptions`): Overrides the default
            settings for this call, e.g, timeout, retries etc.
    ...
    def commit(self,
        ...
        Args:
          project_id (str): The ID of the project against which to make the request.
          mode (~.enums.CommitRequest.Mode): The type of commit to perform. Defaults to ``TRANSACTIONAL``.
          mutations (list[Union[dict|:class:`google.cloud.proto.datastore.v1.datastore_pb2.Mutation`]]): The mutations to perform.
            ...
            entity.
            If a dict is provided, it must be of the same form as the protobuf
            message :class:`google.cloud.proto.datastore.v1.datastore_pb2.Mutation`
    ...
    def allocate_ids(self, project_id, keys, options=None):
        ...
        Args:
          project_id (str): The ID of the project against which to make the request.
          keys (list[Union[dict|:class:`google.cloud.proto.datastore.v1.entity_pb2.Key`]]): A list of keys with incomplete key paths for which to allocate IDs.
