...
class InstanceAdminClient(object):
        ...
        * The instance's state becomes ``READY``.
        ...
        Args:
          ...
          instance_id (str): Required. The ID of the instance to create.  Valid identifiers are of the
            ...
            length.
          instance (Union[dict|:class:`google.cloud.proto.spanner.admin.instance.v1.spanner_instance_admin_pb2.Instance`]): Required. The instance to create.  The name may be omitted, but if
            specified must be ``<parent>/instances/<instance_id>``.
            If a dict is provided, it must be of the same form as the protobuf
            message :class:`google.cloud.proto.spanner.admin.instance.v1.spanner_instance_admin_pb2.Instance`
          options (:class:`google.gax.CallOptions`): Overrides the default
            settings for this call, e.g, timeout, retries etc.
    ...
    def update_instance(self, instance, field_mask, options=None):
        ...
        * The instance's new resource levels are readable via the API.
        ...
        Args:
          instance (Union[dict|:class:`google.cloud.proto.spanner.admin.instance.v1.spanner_instance_admin_pb2.Instance`]): Required. The instance to update, which must always include the instance
            name.  Otherwise, only fields mentioned in [][google.spanner.admin.instance.v1.UpdateInstanceRequest.field_mask] need be included.
            If a dict is provided, it must be of the same form as the protobuf
            message :class:`google.cloud.proto.spanner.admin.instance.v1.spanner_instance_admin_pb2.Instance`
          field_mask (Union[dict|:class:`google.protobuf.field_mask_pb2.FieldMask`]): Required. A mask specifying which fields in [][google.spanner.admin.instance.v1.UpdateInstanceRequest.instance] should be updated.
