...
# source: google/cloud/grpc/functions/v1beta2/functions.proto
...
CloudFunction = _reflection.GeneratedProtocolMessageType('CloudFunction', (_message.Message,), dict(
  ...
  __module__ = 'google.cloud.grpc.functions.v1beta2.functions_pb2'
