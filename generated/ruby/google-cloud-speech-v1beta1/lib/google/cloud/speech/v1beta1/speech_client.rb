    ...
    module Speech
      module V1beta1
        ...
        class SpeechClient
          ...
          #
          # @param config [Google::Cloud::Speech::V1beta1::RecognitionConfig | Hash]
          #   *Required* Provides information to the recognizer that specifies how to
          #   process the request.
          #   A hash of the same form as `Google::Cloud::Speech::V1beta1::RecognitionConfig`
          #   can also be provided.
          # @param audio [Google::Cloud::Speech::V1beta1::RecognitionAudio | Hash]
          #   *Required* The audio data to be recognized.
          #   A hash of the same form as `Google::Cloud::Speech::V1beta1::RecognitionAudio`
          #   can also be provided.
          ...
          def sync_recognize \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Speech::V1beta1::SyncRecognizeRequest)
          ...
          def async_recognize \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Speech::V1beta1::AsyncRecognizeRequest)
