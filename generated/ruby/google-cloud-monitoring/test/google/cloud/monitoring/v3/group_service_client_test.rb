...
describe Google::Cloud::Monitoring::V3::GroupServiceClient do
  ...
  describe 'list_groups' do
    ...
    it 'invokes list_groups without error' do
      ...
      # Mock auth layer
      mock_credentials = MockCredentialsClass.new("list_groups")
  ...
  describe 'create_group' do
    ...
    it 'invokes create_group without error' do
      ...
      # Mock auth layer
      mock_credentials = MockCredentialsClass.new("create_group")
  ...
  describe 'delete_group' do
    ...
    it 'invokes delete_group without error' do
      ...
      # Mock auth layer
      mock_credentials = MockCredentialsClass.new("delete_group")
  ...
  describe 'list_group_members' do
    ...
    it 'invokes list_group_members without error' do
      ...
      # Mock auth layer
      mock_credentials = MockCredentialsClass.new("list_group_members")
