...
module Google
  module Cloud
    ...
    module Monitoring
      ...
      # [MetricServiceClient]: https://googlecloudplatform.github.io/google-cloud-ruby/#/docs/google-cloud-monitoring/latest/google/monitoring/v3/v3/metricserviceclient
      # [Data Types]: https://googlecloudplatform.github.io/google-cloud-ruby/#/docs/google-cloud-monitoring/latest/google/monitoring/v3/v3/datatypes
      #
      module V3
        ...
        module Group
          ...
          def self.new(*args, **kwargs)
            Google::Cloud::Monitoring::V3::GroupServiceClient.new(*args, **kwargs)
          end
        end
        ...
        module Metric
          ...
          #   The default timeout, in seconds, for calls made through this client.
          def self.new(*args, **kwargs)
            Google::Cloud::Monitoring::V3::MetricServiceClient.new(*args, **kwargs)
          end
        end
      end
    end
