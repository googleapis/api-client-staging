...
module Google
  module Cloud
    ...
    module Spanner
      ...
      FILE_DIR = File.realdirpath(Pathname.new(__FILE__).join("..").join("spanner"))
      ...
      def self.new(*args, version: :v1, **kwargs)
        ...
        version_module = Google::Cloud::Spanner
          .constants
          .select {|sym| sym.to_s.downcase == version.to_s.downcase}
          .first
        Google::Cloud::Spanner.const_get(version_module).new(*args, **kwargs)
      end
    end
  end
end