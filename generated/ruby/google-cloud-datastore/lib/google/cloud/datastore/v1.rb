...
module Google
  module Cloud
    ...
    module Datastore
      ...
      # [Data Types]: https://googlecloudplatform.github.io/google-cloud-ruby/#/docs/google-cloud-datastore/latest/google/datastore/v1/v1/datatypes
      #
      module V1
        ...
        def self.new(*args, **kwargs)
          Google::Cloud::Datastore::V1::DatastoreClient.new(*args, **kwargs)
        end
      end
    end
  end
