...
class MockPublisherCredentials < Google::Cloud::Pubsub::V1::Credentials
...
describe Google::Cloud::Pubsub::V1::PublisherClient do
  ...
  describe 'update_topic' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Pubsub::V1::PublisherClient#update_topic."
