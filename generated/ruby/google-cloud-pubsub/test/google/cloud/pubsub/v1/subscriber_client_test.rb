...
class MockSubscriberCredentials < Google::Cloud::Pubsub::V1::Credentials
...
describe Google::Cloud::Pubsub::V1::SubscriberClient do
  ...
  describe 'create_subscription' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Pubsub::V1::SubscriberClient#create_subscription."
    ...
    it 'invokes create_subscription without error' do
      ...
      # Mock auth layer
      mock_credentials = MockSubscriberCredentials.new("create_subscription")
  ...
  describe 'get_subscription' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Pubsub::V1::SubscriberClient#get_subscription."
    ...
    it 'invokes get_subscription without error' do
      ...
      # Mock auth layer
      mock_credentials = MockSubscriberCredentials.new("get_subscription")
  ...
  describe 'update_subscription' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Pubsub::V1::SubscriberClient#update_subscription."
    ...
    it 'invokes update_subscription without error' do
      ...
      # Mock auth layer
      mock_credentials = MockSubscriberCredentials.new("update_subscription")
  ...
  describe 'list_subscriptions' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Pubsub::V1::SubscriberClient#list_subscriptions."
    ...
    it 'invokes list_subscriptions without error' do
      ...
      # Mock auth layer
      mock_credentials = MockSubscriberCredentials.new("list_subscriptions")
  ...
  describe 'delete_subscription' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Pubsub::V1::SubscriberClient#delete_subscription."
    ...
    it 'invokes delete_subscription without error' do
      ...
      # Mock auth layer
      mock_credentials = MockSubscriberCredentials.new("delete_subscription")
  ...
  describe 'modify_ack_deadline' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Pubsub::V1::SubscriberClient#modify_ack_deadline."
    ...
    it 'invokes modify_ack_deadline without error' do
      ...
      # Mock auth layer
      mock_credentials = MockSubscriberCredentials.new("modify_ack_deadline")
  ...
  describe 'acknowledge' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Pubsub::V1::SubscriberClient#acknowledge."
    ...
    it 'invokes acknowledge without error' do
      ...
      # Mock auth layer
      mock_credentials = MockSubscriberCredentials.new("acknowledge")
  ...
  describe 'pull' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Pubsub::V1::SubscriberClient#pull."
    ...
    it 'invokes pull without error' do
      ...
      # Mock auth layer
      mock_credentials = MockSubscriberCredentials.new("pull")
  ...
  describe 'streaming_pull' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Pubsub::V1::SubscriberClient#streaming_pull."
    ...
    it 'invokes streaming_pull without error' do
      ...
      # Mock auth layer
      mock_credentials = MockSubscriberCredentials.new("streaming_pull")
  ...
  describe 'modify_push_config' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Pubsub::V1::SubscriberClient#modify_push_config."
    ...
    it 'invokes modify_push_config without error' do
      ...
      # Mock auth layer
      mock_credentials = MockSubscriberCredentials.new("modify_push_config")
  ...
  describe 'list_snapshots' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Pubsub::V1::SubscriberClient#list_snapshots."
    ...
    it 'invokes list_snapshots without error' do
      ...
      # Mock auth layer
      mock_credentials = MockSubscriberCredentials.new("list_snapshots")
  ...
  describe 'create_snapshot' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Pubsub::V1::SubscriberClient#create_snapshot."
    ...
    it 'invokes create_snapshot without error' do
      ...
      # Mock auth layer
      mock_credentials = MockSubscriberCredentials.new("create_snapshot")
  ...
  describe 'update_snapshot' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Pubsub::V1::SubscriberClient#update_snapshot."
    ...
    it 'invokes update_snapshot without error' do
      ...
      mock_stub = MockGrpcClientStub.new(:update_snapshot, mock_method)

      # Mock auth layer
      mock_credentials = MockSubscriberCredentials.new("update_snapshot")
  ...
  describe 'delete_snapshot' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Pubsub::V1::SubscriberClient#delete_snapshot."
    ...
    it 'invokes delete_snapshot without error' do
      ...
      # Mock auth layer
      mock_credentials = MockSubscriberCredentials.new("delete_snapshot")
  ...
  describe 'seek' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Pubsub::V1::SubscriberClient#seek."
    ...
    it 'invokes seek without error' do
      ...
      # Mock auth layer
      mock_credentials = MockSubscriberCredentials.new("seek")
  ...
  describe 'set_iam_policy' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Pubsub::V1::SubscriberClient#set_iam_policy."
    ...
    it 'invokes set_iam_policy without error' do
      ...
      # Mock auth layer
      mock_credentials = MockSubscriberCredentials.new("set_iam_policy")
  ...
  describe 'get_iam_policy' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Pubsub::V1::SubscriberClient#get_iam_policy."
    ...
    it 'invokes get_iam_policy without error' do
      ...
      # Mock auth layer
      mock_credentials = MockSubscriberCredentials.new("get_iam_policy")
  ...
  describe 'test_iam_permissions' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Pubsub::V1::SubscriberClient#test_iam_permissions."
    ...
    it 'invokes test_iam_permissions without error' do
      ...
      # Mock auth layer
      mock_credentials = MockSubscriberCredentials.new("test_iam_permissions")
