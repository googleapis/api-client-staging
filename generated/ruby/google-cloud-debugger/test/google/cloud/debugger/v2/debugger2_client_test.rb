...
class MockCredentialsClass < Google::Cloud::Debugger::Credentials
...
describe Google::Cloud::Debugger::V2::Debugger2Client do
  ...
  describe 'set_breakpoint' do
    ...
    it 'invokes set_breakpoint without error' do
      ...
      # Mock auth layer
      mock_credentials = MockCredentialsClass.new("set_breakpoint")

      Google::Devtools::Clouddebugger::V2::Debugger2::Stub.stub(:new, mock_stub) do
        Google::Cloud::Debugger::Credentials.stub(:default, mock_credentials) do
          client = Google::Cloud::Debugger::Debugger2.new(version: :v2)
  ...
  describe 'get_breakpoint' do
    ...
    it 'invokes get_breakpoint without error' do
      ...
      # Mock auth layer
      mock_credentials = MockCredentialsClass.new("get_breakpoint")
  ...
  describe 'delete_breakpoint' do
    ...
    it 'invokes delete_breakpoint without error' do
      ...
      # Mock auth layer
      mock_credentials = MockCredentialsClass.new("delete_breakpoint")
  ...
  describe 'list_breakpoints' do
    ...
    it 'invokes list_breakpoints without error' do
      ...
      # Mock auth layer
      mock_credentials = MockCredentialsClass.new("list_breakpoints")
  ...
  describe 'list_debuggees' do
    ...
    it 'invokes list_debuggees without error' do
      ...
      # Mock auth layer
      mock_credentials = MockCredentialsClass.new("list_debuggees")
