...
module Google
  module Cloud
    ...
    module Debugger
      ...
      FILE_DIR = File.realdirpath(Pathname.new(__FILE__).join("..").join("debugger"))
      ...
      module Debugger2
        ...
        def self.new(*args, version: :v2, **kwargs)
          ...
          version_module = Google::Cloud::Debugger
            .constants
            .select {|sym| sym.to_s.downcase == version.to_s.downcase}
            .first
          Google::Cloud::Debugger.const_get(version_module)::Debugger2.new(*args, **kwargs)
        end
      end
      ...
      module Controller2
        ...
        def self.new(*args, version: :v2, **kwargs)
          ...
          version_module = Google::Cloud::Debugger
            ...
            .select {|sym| sym.to_s.downcase == version.to_s.downcase}
            .first
          Google::Cloud::Debugger.const_get(version_module)::Controller2.new(*args, **kwargs)
        end
      end
    end
  end
