...
Gem::Specification.new do |s|
  s.name          = "google-cloud-language"
  s.version       = "0.6.8"

  s.authors       = ["Google Inc"]
  s.description   = "Google Cloud Natural Language API client for Ruby."
  ...
  s.summary       = "GRPC library for Google Cloud Natural Language API"
