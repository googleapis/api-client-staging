...
describe Google::Cloud::Pubsub::V1::SubscriberClient do
  ...
  describe 'create_subscription' do
    ...
    it 'invokes create_subscription without error' do
      ...
      expected_response = Google::Pubsub::V1::Subscription.new(
        name: name_2,
        topic: topic_2,
      ...
      Google::Pubsub::V1::Subscriber::Stub.stub(:new, mock_stub) do
        client = Google::Cloud::Pubsub::V1::SubscriberClient.new
  ...
  describe 'list_subscriptions' do
    ...
    it 'invokes list_subscriptions without error' do
      ...
      # Create expected grpc response
      next_page_token = ""
      subscriptions_element = Google::Pubsub::V1::Subscription.new
      subscriptions = [subscriptions_element]
      expected_response = Google::Pubsub::V1::ListSubscriptionsResponse.new(next_page_token: next_page_token, subscriptions: subscriptions)
  ...
  describe 'pull' do
    ...
    it 'invokes pull without error' do
      ...
      # Create expected grpc response
      expected_response = Google::Pubsub::V1::PullResponse.new
  ...
  describe 'streaming_pull' do
    ...
    it 'invokes streaming_pull without error' do
      ...
      # Create expected grpc response
      expected_response = Google::Pubsub::V1::StreamingPullResponse.new
  ...
  describe 'list_snapshots' do
    ...
    it 'invokes list_snapshots without error' do
      ...
      # Create expected grpc response
      next_page_token = ""
      snapshots_element = Google::Pubsub::V1::Snapshot.new
      snapshots = [snapshots_element]
      expected_response = Google::Pubsub::V1::ListSnapshotsResponse.new(next_page_token: next_page_token, snapshots: snapshots)
  ...
  describe 'create_snapshot' do
    ...
    it 'invokes create_snapshot without error' do
      ...
      name_2 = "name2-1052831874"
      topic = "topic110546223"
      expected_response = Google::Pubsub::V1::Snapshot.new(name: name_2, topic: topic)
  ...
  describe 'seek' do
    ...
    it 'invokes seek without error' do
      ...
      # Create expected grpc response
      expected_response = Google::Pubsub::V1::SeekResponse.new
