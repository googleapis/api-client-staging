...
Gem::Specification.new do |s|
  s.name          = "google-cloud-iam-admin"
  s.version       = "0.6.8"

  s.authors       = ["Google Inc"]
  s.description   = "Google Identity and Access Management (IAM) API client for Ruby."
  ...
  s.summary       = "GRPC library for Google Identity and Access Management (IAM) API"

  s.add_dependency "grpc", "~> 1.0"
  s.add_dependency "googleauth", "~> 0.5.1"
  s.add_dependency "google-gax", "~> 0.8.0"
  s.add_dependency "grpc-google-iam", "~> 0.6.8"
