...
module Google
  module Cloud
    ...
    module Language
      ...
      #
      # [LanguageServiceClient]: https://googlecloudplatform.github.io/google-cloud-ruby/#/docs/google-cloud-language/latest/google/cloud/language/v1beta2/v1beta2/languageserviceclient
      # [Data Types]: https://googlecloudplatform.github.io/google-cloud-ruby/#/docs/google-cloud-language/latest/google/cloud/language/v1beta2/v1beta2/datatypes
      #
      module V1beta2
        ...
        def self.new(*args, **kwargs)
          Google::Cloud::Language::V1beta2::LanguageServiceClient.new(*args, **kwargs)
        end
      end
    end
  end
