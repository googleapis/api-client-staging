...
module Google
  module Cloud
    module Iam
      ...
      module Admin
        ##
        # # Google Identity and Access Management (IAM) API Contents
        #
        # | Class | Description |
        # | ----- | ----------- |
        # | [IamClient][] | Manages identity and access control for Google Cloud Platform resources, including the creation of service accounts, which you can use to authenticate to Google and make API calls. |
        # | [Data Types][] | Data types for Google::Cloud::Iam::Admin::V1 |
        #
        # [IamClient]: https://googlecloudplatform.github.io/google-cloud-ruby/#/docs/google-cloud-iam-admin/latest/google/iam/admin/v1/v1/iamclient
        # [Data Types]: https://googlecloudplatform.github.io/google-cloud-ruby/#/docs/google-cloud-iam-admin/latest/google/iam/admin/v1/v1/datatypes
        #
        module V1
          ...
          def self.new(*args, **kwargs)
            Google::Cloud::Iam::Admin::V1::IamClient.new(*args, **kwargs)
          end
        end
      end
    end
