...
class MockCredentialsClass < Google::Cloud::Spanner::Admin::Database::Credentials
...
describe Google::Cloud::Spanner::Admin::Database::V1::DatabaseAdminClient do
  ...
  describe 'list_databases' do
    ...
    it 'invokes list_databases without error' do
      ...
      # Mock auth layer
      mock_credentials = MockCredentialsClass.new("list_databases")
  ...
  describe 'get_database' do
    ...
    it 'invokes get_database without error' do
      ...
      # Mock auth layer
      mock_credentials = MockCredentialsClass.new("get_database")
  ...
  describe 'drop_database' do
    ...
    it 'invokes drop_database without error' do
      ...
      # Mock auth layer
      mock_credentials = MockCredentialsClass.new("drop_database")
  ...
  describe 'get_database_ddl' do
    ...
    it 'invokes get_database_ddl without error' do
      ...
      # Mock auth layer
      mock_credentials = MockCredentialsClass.new("get_database_ddl")
