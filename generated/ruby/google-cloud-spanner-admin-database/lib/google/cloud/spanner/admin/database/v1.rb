    ...
    module Spanner
      module Admin
        ...
        module Database
          ...
          #
          # [DatabaseAdminClient]: https://googlecloudplatform.github.io/google-cloud-ruby/#/docs/google-cloud-spanner-admin-database/latest/google/spanner/admin/database/v1/v1/databaseadminclient
          # [Data Types]: https://googlecloudplatform.github.io/google-cloud-ruby/#/docs/google-cloud-spanner-admin-database/latest/google/spanner/admin/database/v1/v1/datatypes
          #
          module V1
            ...
            def self.new(*args, **kwargs)
              Google::Cloud::Spanner::Admin::Database::V1::DatabaseAdminClient.new(*args, **kwargs)
            end
          end
        end
      end
