...
public class DlpServiceSettings extends ClientSettings {
  ...
  private static final String PROPERTIES_FILE = "/com/google/cloud/privacy/dlp/project.properties";
  ...
  private final SimpleCallSettings<CreateInspectOperationRequest, Operation>
  ...
  public SimpleCallSettings<CreateInspectOperationRequest, Operation>
      createInspectOperationSettings() {
  ...
  public static class Builder extends ClientSettings.Builder {
    ...
    private final SimpleCallSettings.Builder<RedactContentRequest, RedactContentResponse>
        redactContentSettings;
    private final SimpleCallSettings.Builder<CreateInspectOperationRequest, Operation>
        createInspectOperationSettings;
    ...
    public SimpleCallSettings.Builder<CreateInspectOperationRequest, Operation>
        createInspectOperationSettings() {
      return createInspectOperationSettings;
    }
