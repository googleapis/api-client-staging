...
public  final class TrafficSplit extends
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 18: {
            ...
            allocations = input.readMessage(
                AllocationsDefaultEntryHolder.defaultEntry.getParserForType(), extensionRegistry);
            allocations_.getMutableMap().put(allocations.getKey(), allocations.getValue());
            break;
          }
        }
      }
   ...
   * </pre>
   *
   * <code>optional .google.appengine.v1.TrafficSplit.ShardBy shard_by = 1;</code>
   */
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    for (java.util.Map.Entry<java.lang.String, java.lang.Double> entry
      ...
      com.google.protobuf.MapEntry<java.lang.String, java.lang.Double>
      allocations = AllocationsDefaultEntryHolder.defaultEntry.newBuilderForType()
          .setKey(entry.getKey())
          .setValue(entry.getValue())
          .build();
      output.writeMessage(2, allocations);
    }
  }
  ...
  public int getSerializedSize() {
    ...
    for (java.util.Map.Entry<java.lang.String, java.lang.Double> entry
      ...
      allocations = AllocationsDefaultEntryHolder.defaultEntry.newBuilderForType()
          ...
          .build();
      size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(2, allocations);
    }
    memoizedSize = size;
    return size;
  }
  ...
  public static final class Builder extends
    ...
    public Builder removeAllocations(
        java.lang.String key) {
      if (key == null) { throw new java.lang.NullPointerException(); }
      getMutableAllocations().remove(key);
      return this;
    }
    /**
    ...
    public Builder putAllocations(
      ...
      getMutableAllocations().put(key, value);
      return this;
    }
    /**
     * <pre>
    ...
    public Builder putAllAllocations(
      ...
      getMutableAllocations().putAll(values);
      return this;
    }
