...
public abstract class AnySinkName implements ResourceName {
  protected AnySinkName() {}

  public static AnySinkName parse(String resourceNameString) {
    if (SinkName.isParsableFrom(resourceNameString)) {
      return SinkName.parse(resourceNameString);
    }
