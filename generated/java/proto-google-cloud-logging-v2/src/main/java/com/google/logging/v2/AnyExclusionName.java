...
public abstract class AnyExclusionName implements ResourceName {
  protected AnyExclusionName() {}

  public static AnyExclusionName parse(String resourceNameString) {
    if (ExclusionName.isParsableFrom(resourceNameString)) {
      return ExclusionName.parse(resourceNameString);
    }
