...
public interface CharacterMaskConfigOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.privacy.dlp.v2beta2.CharacterMaskConfig)
   ...
   */
  java.util.List<com.google.privacy.dlp.v2beta2.CharsToIgnore> 
   ...
   * <code>repeated .google.privacy.dlp.v2beta2.CharsToIgnore characters_to_ignore = 4;</code>
   */
  com.google.privacy.dlp.v2beta2.CharsToIgnore getCharactersToIgnore(int index);
  /**
   * <pre>
   * When masking a string, items in this list will be skipped when replacing.
   * For example, if your string is 555-555-5555 and you ask us to skip `-` and
   ...
   * <code>repeated .google.privacy.dlp.v2beta2.CharsToIgnore characters_to_ignore = 4;</code>
   */
  java.util.List<? extends com.google.privacy.dlp.v2beta2.CharsToIgnoreOrBuilder> 
   ...
   * <code>repeated .google.privacy.dlp.v2beta2.CharsToIgnore characters_to_ignore = 4;</code>
   */
  com.google.privacy.dlp.v2beta2.CharsToIgnoreOrBuilder getCharactersToIgnoreOrBuilder(
      int index);
}
