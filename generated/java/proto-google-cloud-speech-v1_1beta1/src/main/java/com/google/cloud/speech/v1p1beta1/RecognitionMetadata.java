...
public  final class RecognitionMetadata extends
   ...
   * </pre>
   *
   * Protobuf enum {@code google.cloud.speech.v1p1beta1.RecognitionMetadata.NumberOfSpeakers}
   */
  public enum NumberOfSpeakers
      implements com.google.protobuf.ProtocolMessageEnum {
    /**
     * <pre>
     ...
     * </pre>
     *
     * <code>NUMBER_OF_SPEAKERS_UNSPECIFIED = 0;</code>
     */
     ...
     * <code>NUMBER_OF_SPEAKERS_UNSPECIFIED = 0;</code>
     */
    public static final int NUMBER_OF_SPEAKERS_UNSPECIFIED_VALUE = 0;
    /**
     * <pre>
     * Only one person is the prominent speaker (ignore background voices).
     * </pre>
     ...
     * <code>ONE_SPEAKER = 1;</code>
     */
    public static final int ONE_SPEAKER_VALUE = 1;
    /**
     * <pre>
     * Two people are the prominent speakers (transcript should focus
     * on the two most prominent speakers).
     ...
     * <code>TWO_SPEAKERS = 2;</code>
     */
    public static final int TWO_SPEAKERS_VALUE = 2;
    /**
     * <pre>
     * Transcribe all voices.
     * </pre>
     ...
     * <code>MULTIPLE_SPEAKERS = 3;</code>
     */
    public static final int MULTIPLE_SPEAKERS_VALUE = 3;
     ...
     */
    @java.lang.Deprecated
    public static NumberOfSpeakers valueOf(int value) {
      return forNumber(value);
    }

    public static NumberOfSpeakers forNumber(int value) {
      switch (value) {
        case 0: return NUMBER_OF_SPEAKERS_UNSPECIFIED;
        case 1: return ONE_SPEAKER;
        case 2: return TWO_SPEAKERS;
        case 3: return MULTIPLE_SPEAKERS;
        default: return null;
      }
    }

    public static com.google.protobuf.Internal.EnumLiteMap<NumberOfSpeakers>
        internalGetValueMap() {
      return internalValueMap;
    }
    private static final com.google.protobuf.Internal.EnumLiteMap<
        NumberOfSpeakers> internalValueMap =
          new com.google.protobuf.Internal.EnumLiteMap<NumberOfSpeakers>() {
            public NumberOfSpeakers findValueByNumber(int number) {
              return NumberOfSpeakers.forNumber(number);
            }
          };
    ...
    private static final NumberOfSpeakers[] VALUES = values();

    public static NumberOfSpeakers valueOf(
        com.google.protobuf.Descriptors.EnumValueDescriptor desc) {
      if (desc.getType() != getDescriptor()) {
        throw new java.lang.IllegalArgumentException(
          "EnumValueDescriptor is not for this type.");
    ...
    private NumberOfSpeakers(int value) {
      this.value = value;
    }

    // @@protoc_insertion_point(enum_scope:google.cloud.speech.v1p1beta1.RecognitionMetadata.NumberOfSpeakers)
  }
  ...
  public enum RecordingDeviceType
    ...
    public static final com.google.protobuf.Descriptors.EnumDescriptor
        getDescriptor() {
      return com.google.cloud.speech.v1p1beta1.RecognitionMetadata.getDescriptor().getEnumTypes().get(4);
    }
  ...
  public static final int NUMBER_OF_SPEAKERS_FIELD_NUMBER = 6;
  private int numberOfSpeakers_;
  /**
   * <pre>
   ...
   * </pre>
   *
   * <code>.google.cloud.speech.v1p1beta1.RecognitionMetadata.NumberOfSpeakers number_of_speakers = 6;</code>
   */
  public int getNumberOfSpeakersValue() {
    return numberOfSpeakers_;
  }
  /**
   * <pre>
   * How many people are speaking prominently in the audio and expected to be
   ...
   * <code>.google.cloud.speech.v1p1beta1.RecognitionMetadata.NumberOfSpeakers number_of_speakers = 6;</code>
   */
  public com.google.cloud.speech.v1p1beta1.RecognitionMetadata.NumberOfSpeakers getNumberOfSpeakers() {
    com.google.cloud.speech.v1p1beta1.RecognitionMetadata.NumberOfSpeakers result = com.google.cloud.speech.v1p1beta1.RecognitionMetadata.NumberOfSpeakers.valueOf(numberOfSpeakers_);
    return result == null ? com.google.cloud.speech.v1p1beta1.RecognitionMetadata.NumberOfSpeakers.UNRECOGNIZED : result;
  }

  public static final int RECORDING_DEVICE_TYPE_FIELD_NUMBER = 7;
   ...
   * </pre>
   *
   * <code>.google.cloud.speech.v1p1beta1.RecognitionMetadata.RecordingDeviceType recording_device_type = 7;</code>
   */
  ...
  public static final int RECORDING_DEVICE_NAME_FIELD_NUMBER = 8;
   ...
   * </pre>
   *
   * <code>string recording_device_name = 8;</code>
   */
  ...
  public static final int ORIGINAL_MIME_TYPE_FIELD_NUMBER = 9;
   ...
   * </pre>
   *
   * <code>string original_mime_type = 9;</code>
   */
  ...
  public static final int OBFUSCATED_ID_FIELD_NUMBER = 10;
   ...
   * </pre>
   *
   * <code>int64 obfuscated_id = 10;</code>
   */
  public long getObfuscatedId() {
    return obfuscatedId_;
  }

  public static final int AUDIO_TOPIC_FIELD_NUMBER = 11;
   ...
   * </pre>
   *
   * <code>string audio_topic = 11;</code>
   */
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (numberOfSpeakers_ != com.google.cloud.speech.v1p1beta1.RecognitionMetadata.NumberOfSpeakers.NUMBER_OF_SPEAKERS_UNSPECIFIED.getNumber()) {
      output.writeEnum(6, numberOfSpeakers_);
    }
    if (recordingDeviceType_ != com.google.cloud.speech.v1p1beta1.RecognitionMetadata.RecordingDeviceType.RECORDING_DEVICE_TYPE_UNSPECIFIED.getNumber()) {
      output.writeEnum(7, recordingDeviceType_);
    }
    if (!getRecordingDeviceNameBytes().isEmpty()) {
      com.google.protobuf.GeneratedMessageV3.writeString(output, 8, recordingDeviceName_);
    }
    if (!getOriginalMimeTypeBytes().isEmpty()) {
      com.google.protobuf.GeneratedMessageV3.writeString(output, 9, originalMimeType_);
    }
    if (obfuscatedId_ != 0L) {
      output.writeInt64(10, obfuscatedId_);
    }
    if (!getAudioTopicBytes().isEmpty()) {
      com.google.protobuf.GeneratedMessageV3.writeString(output, 11, audioTopic_);
    }
  }
  ...
  public int getSerializedSize() {
    ...
    if (numberOfSpeakers_ != com.google.cloud.speech.v1p1beta1.RecognitionMetadata.NumberOfSpeakers.NUMBER_OF_SPEAKERS_UNSPECIFIED.getNumber()) {
      size += com.google.protobuf.CodedOutputStream
        .computeEnumSize(6, numberOfSpeakers_);
    }
    if (recordingDeviceType_ != com.google.cloud.speech.v1p1beta1.RecognitionMetadata.RecordingDeviceType.RECORDING_DEVICE_TYPE_UNSPECIFIED.getNumber()) {
      size += com.google.protobuf.CodedOutputStream
        .computeEnumSize(7, recordingDeviceType_);
    }
    if (!getRecordingDeviceNameBytes().isEmpty()) {
      size += com.google.protobuf.GeneratedMessageV3.computeStringSize(8, recordingDeviceName_);
    }
    if (!getOriginalMimeTypeBytes().isEmpty()) {
      size += com.google.protobuf.GeneratedMessageV3.computeStringSize(9, originalMimeType_);
    }
    if (obfuscatedId_ != 0L) {
      size += com.google.protobuf.CodedOutputStream
        .computeInt64Size(10, obfuscatedId_);
    }
    if (!getAudioTopicBytes().isEmpty()) {
      size += com.google.protobuf.GeneratedMessageV3.computeStringSize(11, audioTopic_);
    }
    memoizedSize = size;
    return size;
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    result = result && numberOfSpeakers_ == other.numberOfSpeakers_;
  ...
  public int hashCode() {
    ...
    hash = (37 * hash) + NUMBER_OF_SPEAKERS_FIELD_NUMBER;
    hash = (53 * hash) + numberOfSpeakers_;
  ...
  public static final class Builder extends
    ...
    public com.google.cloud.speech.v1p1beta1.RecognitionMetadata buildPartial() {
      ...
      result.numberOfSpeakers_ = numberOfSpeakers_;
    ...
    public Builder mergeFrom(com.google.cloud.speech.v1p1beta1.RecognitionMetadata other) {
      ...
      if (other.numberOfSpeakers_ != 0) {
        setNumberOfSpeakersValue(other.getNumberOfSpeakersValue());
      }
    ...
    private int numberOfSpeakers_ = 0;
    /**
     * <pre>
     * How many people are speaking prominently in the audio and expected to be
     * recognized.
     ...
     * <code>.google.cloud.speech.v1p1beta1.RecognitionMetadata.NumberOfSpeakers number_of_speakers = 6;</code>
     */
    public Builder setNumberOfSpeakersValue(int value) {
      numberOfSpeakers_ = value;
      onChanged();
      return this;
    }
    /**
     ...
     * <code>.google.cloud.speech.v1p1beta1.RecognitionMetadata.NumberOfSpeakers number_of_speakers = 6;</code>
     */
    public Builder setNumberOfSpeakers(com.google.cloud.speech.v1p1beta1.RecognitionMetadata.NumberOfSpeakers value) {
      if (value == null) {
        throw new NullPointerException();
      }
      
      numberOfSpeakers_ = value.getNumber();
      onChanged();
      return this;
    }
    /**
     ...
     * <code>.google.cloud.speech.v1p1beta1.RecognitionMetadata.NumberOfSpeakers number_of_speakers = 6;</code>
     */
    public Builder clearNumberOfSpeakers() {
