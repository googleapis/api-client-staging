...
public  final class Deployment extends
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 10: {
            ...
            files = input.readMessage(
                FilesDefaultEntryHolder.defaultEntry.getParserForType(), extensionRegistry);
            files_.getMutableMap().put(files.getKey(), files.getValue());
            break;
          }
          case 18: {
   ...
   * </pre>
   *
   * <code>optional .google.appengine.v1.ContainerInfo container = 2;</code>
   */
   ...
   * </pre>
   *
   * <code>optional .google.appengine.v1.ZipInfo zip = 3;</code>
   */
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    for (java.util.Map.Entry<java.lang.String, com.google.appengine.v1.FileInfo> entry
      ...
      com.google.protobuf.MapEntry<java.lang.String, com.google.appengine.v1.FileInfo>
      files = FilesDefaultEntryHolder.defaultEntry.newBuilderForType()
          .setKey(entry.getKey())
          .setValue(entry.getValue())
          .build();
      output.writeMessage(1, files);
    }
    if (container_ != null) {
