...
public  final class Version extends
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 106: {
            ...
            betaSettings = input.readMessage(
                BetaSettingsDefaultEntryHolder.defaultEntry.getParserForType(), extensionRegistry);
            betaSettings_.getMutableMap().put(betaSettings.getKey(), betaSettings.getValue());
            break;
          }
          case 114: {
            java.lang.String s = input.readStringRequireUtf8();
          ...
          case 834: {
            ...
            com.google.protobuf.MapEntry<java.lang.String, java.lang.String>
            envVariables = input.readMessage(
                EnvVariablesDefaultEntryHolder.defaultEntry.getParserForType(), extensionRegistry);
            envVariables_.getMutableMap().put(envVariables.getKey(), envVariables.getValue());
            break;
          }
          case 842: {
   ...
   * </pre>
   *
   * <code>optional .google.appengine.v1.AutomaticScaling automatic_scaling = 3;</code>
   */
   ...
   * </pre>
   *
   * <code>optional .google.appengine.v1.BasicScaling basic_scaling = 4;</code>
   */
   ...
   * </pre>
   *
   * <code>optional .google.appengine.v1.ManualScaling manual_scaling = 5;</code>
   */
   ...
   * </pre>
   *
   * <code>optional string instance_class = 7;</code>
   */
   ...
   * </pre>
   *
   * <code>optional .google.appengine.v1.Network network = 8;</code>
   */
   ...
   * </pre>
   *
   * <code>optional .google.appengine.v1.Resources resources = 9;</code>
   */
   ...
   * </pre>
   *
   * <code>optional string runtime = 10;</code>
   */
   ...
   * </pre>
   *
   * <code>optional bool threadsafe = 11;</code>
   */
   ...
   * </pre>
   *
   * <code>optional string env = 14;</code>
   */
   ...
   * </pre>
   *
   * <code>optional .google.appengine.v1.ServingStatus serving_status = 15;</code>
   */
   ...
   * </pre>
   *
   * <code>optional string created_by = 16;</code>
   */
   ...
   * </pre>
   *
   * <code>optional .google.protobuf.Timestamp create_time = 17;</code>
   */
   ...
   * </pre>
   *
   * <code>optional int64 disk_usage_bytes = 18;</code>
   */
   ...
   * </pre>
   *
   * <code>optional .google.appengine.v1.ApiConfigHandler api_config = 103;</code>
   */
   ...
   * </pre>
   *
   * <code>optional .google.protobuf.Duration default_expiration = 105;</code>
   */
   ...
   * </pre>
   *
   * <code>optional .google.appengine.v1.HealthCheck health_check = 106;</code>
   */
   ...
   * </pre>
   *
   * <code>optional string nobuild_files_regex = 107;</code>
   */
   ...
   * </pre>
   *
   * <code>optional .google.appengine.v1.Deployment deployment = 108;</code>
   */
   ...
   * </pre>
   *
   * <code>optional string version_url = 109;</code>
   */
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    for (java.util.Map.Entry<java.lang.String, java.lang.String> entry
      ...
      com.google.protobuf.MapEntry<java.lang.String, java.lang.String>
      betaSettings = BetaSettingsDefaultEntryHolder.defaultEntry.newBuilderForType()
          .setKey(entry.getKey())
          .setValue(entry.getValue())
          .build();
      output.writeMessage(13, betaSettings);
    }
    ...
    for (java.util.Map.Entry<java.lang.String, java.lang.String> entry
      ...
      com.google.protobuf.MapEntry<java.lang.String, java.lang.String>
      envVariables = EnvVariablesDefaultEntryHolder.defaultEntry.newBuilderForType()
          .setKey(entry.getKey())
          .setValue(entry.getValue())
          .build();
      output.writeMessage(104, envVariables);
    }
    if (defaultExpiration_ != null) {
  ...
  public int getSerializedSize() {
    ...
    for (java.util.Map.Entry<java.lang.String, java.lang.String> entry
      ...
      betaSettings = BetaSettingsDefaultEntryHolder.defaultEntry.newBuilderForType()
          ...
          .build();
      size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(13, betaSettings);
    }
    if (!getEnvBytes().isEmpty()) {
    ...
    for (java.util.Map.Entry<java.lang.String, java.lang.String> entry
      ...
      envVariables = EnvVariablesDefaultEntryHolder.defaultEntry.newBuilderForType()
          ...
          .build();
      size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(104, envVariables);
    }
    if (defaultExpiration_ != null) {
      size += com.google.protobuf.CodedOutputStream
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    result = result && getId()
        .equals(other.getId());
    result = result && inboundServices_.equals(other.inboundServices_);
    result = result && getInstanceClass()
        .equals(other.getInstanceClass());
    ...
    result = result && (getThreadsafe()
        == other.getThreadsafe());
    result = result && (getVm()
        == other.getVm());
    result = result && internalGetBetaSettings().equals(
    ...
    result = result && (getDiskUsageBytes()
        == other.getDiskUsageBytes());
    result = result && getHandlersList()
        .equals(other.getHandlersList());
    result = result && getErrorHandlersList()
        .equals(other.getErrorHandlersList());
    result = result && getLibrariesList()
        .equals(other.getLibrariesList());
    result = result && (hasApiConfig() == other.hasApiConfig());
    if (hasApiConfig()) {
      result = result && getApiConfig()
          .equals(other.getApiConfig());
    }
    result = result && internalGetEnvVariables().equals(
        other.internalGetEnvVariables());
    result = result && (hasDefaultExpiration() == other.hasDefaultExpiration());
    if (hasDefaultExpiration()) {
      result = result && getDefaultExpiration()
          .equals(other.getDefaultExpiration());
    }
    result = result && (hasHealthCheck() == other.hasHealthCheck());
    if (hasHealthCheck()) {
      result = result && getHealthCheck()
          .equals(other.getHealthCheck());
    }
    result = result && getNobuildFilesRegex()
        .equals(other.getNobuildFilesRegex());
    ...
    result = result && getVersionUrl()
        .equals(other.getVersionUrl());
    result = result && getScalingCase().equals(
        other.getScalingCase());
    if (!result) return false;
    switch (scalingCase_) {
      case 3:
        result = result && getAutomaticScaling()
            .equals(other.getAutomaticScaling());
        break;
      case 4:
        result = result && getBasicScaling()
            .equals(other.getBasicScaling());
        break;
      case 5:
  ...
  checkByteStringIsUtf8(value);
    ...
    private com.google.appengine.v1.Network network_ = null;
    private com.google.protobuf.SingleFieldBuilderV3<
    ...
    private com.google.appengine.v1.Resources resources_ = null;
    private com.google.protobuf.SingleFieldBuilderV3<
  ...
  checkByteStringIsUtf8(value);
    ...
    public Builder removeBetaSettings(
        java.lang.String key) {
      if (key == null) { throw new java.lang.NullPointerException(); }
      getMutableBetaSettings().remove(key);
      return this;
    }
    /**
    ...
    public Builder putBetaSettings(
      ...
      getMutableBetaSettings().put(key, value);
      return this;
    }
    /**
     * <pre>
    ...
    public Builder putAllBetaSettings(
      ...
      getMutableBetaSettings().putAll(values);
      return this;
    }
  ...
  checkByteStringIsUtf8(value);
    ...
    private com.google.appengine.v1.ApiConfigHandler apiConfig_ = null;
    private com.google.protobuf.SingleFieldBuilderV3<
    ...
    public Builder removeEnvVariables(
        java.lang.String key) {
      if (key == null) { throw new java.lang.NullPointerException(); }
      getMutableEnvVariables().remove(key);
      return this;
    }
    /**
     * Use alternate mutation accessors instead.
    ...
    public Builder putEnvVariables(
      ...
      if (key == null) { throw new java.lang.NullPointerException(); }
      if (value == null) { throw new java.lang.NullPointerException(); }
      getMutableEnvVariables().put(key, value);
      return this;
    }
    /**
     * <pre>
    ...
    public Builder putAllEnvVariables(
        java.util.Map<java.lang.String, java.lang.String> values) {
      getMutableEnvVariables().putAll(values);
      return this;
    }

    private com.google.protobuf.Duration defaultExpiration_ = null;
    private com.google.protobuf.SingleFieldBuilderV3<
    ...
    private com.google.appengine.v1.HealthCheck healthCheck_ = null;
    private com.google.protobuf.SingleFieldBuilderV3<
  ...
  checkByteStringIsUtf8(value);
    ...
    private com.google.appengine.v1.Deployment deployment_ = null;
    private com.google.protobuf.SingleFieldBuilderV3<
