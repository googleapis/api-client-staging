...
private static final long serialVersionUID = 0L;
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    boolean result = true;
    result = result && (getTargetSentBytesPerSecond()
        == other.getTargetSentBytesPerSecond());
    result = result && (getTargetSentPacketsPerSecond()
        == other.getTargetSentPacketsPerSecond());
    result = result && (getTargetReceivedBytesPerSecond()
        == other.getTargetReceivedBytesPerSecond());
    result = result && (getTargetReceivedPacketsPerSecond()
        == other.getTargetReceivedPacketsPerSecond());
