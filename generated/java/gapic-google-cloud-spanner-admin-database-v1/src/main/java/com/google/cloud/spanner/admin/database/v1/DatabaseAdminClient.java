 ...
 * <pre>
 * <code>
 * try (DatabaseAdminClient databaseAdminClient = DatabaseAdminClient.of()) {
 ...
 *
 * <p>This class can be customized by passing in a custom instance of DatabaseAdminSettings to of().
 * For example:
 *
